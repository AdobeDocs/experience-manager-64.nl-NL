...
>[!NOTE]
>
>De Asset Selector werd in eerdere versies van AEM [Asset Picker](https://helpx.adobe.com/experience-manager/6-2/assets/using/asset-picker.html) genoemd.
...
Momenteel kunt u de aanvraagparameters `assettype` (*Afbeelding/Video/Tekst*) en de selectie `mode` (*Enkel/Meervoudig*) doorgeven als contextuele informatie voor de elementenkiezer, die tijdens de selectie intact blijft.
