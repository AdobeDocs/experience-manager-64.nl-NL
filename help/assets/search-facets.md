...
1. Tik op **[!UICONTROL Verwijderen]** en ![verwijder](assets/deleteoutline.png) de omtrek van de werkbalk.
...
| Actie | Machtigingen |
|---|---|
| [!UICONTROL Bewerken] | De lees en schrijft toestemmingen op de /apps knoop in CRX |
| [!UICONTROL Verwijderen] | De lees, schrijft en schrapt toestemmingen op de /apps knoop in CRX |
| [!UICONTROL Voorvertoning] | Lees, schrijf, en schrap toestemmingen op de /var/dam/content knoop in CRX. Ook, lees en schrijf toestemmingen op /apps knoop. |
