...
1. Voer in het dialoogvenster Map **** toevoegen een titel en naam (optioneel) voor de map in en selecteer **[!UICONTROL Privé]**.
...
1. Selecteer op de pagina Mapeigenschappen een gebruiker in de lijst Gebruiker **** toevoegen, wijs een rol toe aan de gebruiker in uw persoonlijke map en klik op **[!UICONTROL Toevoegen]**.
