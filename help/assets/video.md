...
1. **Dynamic Media-video&#39;s uploaden** door het volgende te doen:
   ...
   * Maak uw eigen videocoderingsprofiel. U kunt ook gewoon het vooraf gedefinieerde profiel ‘Adaptive Video Encoding’ gebruiken dat bij Dynamic Media wordt geleverd.
      ...
      * [Een videocoderingsprofiel maken](video-profiles.md).
   ...
   * Koppel het videoverwerkingsprofiel aan een of meer mappen waar u de master video&#39;s gaat uploaden.
      ...
      * Meer informatie over [Aanbevolen procedures voor het ordenen van uw digitale middelen voor het gebruik van verwerkingsprofielen](organize-assets.md#organize-using-folders).
...
1. **Uw Dynamic Media-video&#39;s beheren** door een van de volgende handelingen uit te voeren:
   ...
   * Video-elementen organiseren, doorbladeren en zoeken
      ...
      * [Video-elementen zoeken](search-video-assets.md) of [Elementen zoeken](managing-assets-touch-ui.md#searching-assets)
   * Video-elementen voorvertonen en publiceren
      ...
      * Bekijk de bronvideo en de gecodeerde vertoningen van de video samen met de bijbehorende miniaturen:
         ...
         [Video&#39;s voorvertonen](managing-video-assets.md#uploading-and-previewing-video-assets) of [Elementen voorvertonen](previewing-assets.md)
...
[Video-eigenschappen bewerken](managing-assets-touch-ui.md#editing-properties)
   ...
   * Video&#39;s bekijken, goedkeuren en notities aanbrengen
      ...
      * [Video&#39;s annoteren](managing-video-assets.md#annotating-video-assets) of [Annoteren van elementen](managing-assets-touch-ui.md#annotating)
      * [Workflows toepassen op elementen](assets-workflow.md) of [Een workflow starten op een element](managing-assets-touch-ui.md#starting-a-workflow-on-an-asset)
...
Adaptieve videostreaming wordt ondersteund op verschillende iOS-platforms. Zie de [Referentiehandleiding voor Adobe Viewers](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/homeviewers.html).
...
Zie ook [HTML5-viewers](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/viewers-for-aem-assets-only/c-html5-aem-asset-viewers.html#viewers-for-aem-assets-only) in de Adobe Dynamic Media Viewers Reference Guide.
...
Zie ook [HTML5-viewers](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/viewers-for-aem-assets-only/c-html5-aem-asset-viewers.html) in de Adobe Viewers Reference Guide.
...
De **[!UICONTROL Dynamic Media Encode Video]** de workflow codeert video als u dynamische media hebt ingeschakeld en videocloudservices hebt ingesteld. In deze workflow worden de historie en informatie over fouten van het workflowproces vastgelegd. Zie [De voortgang van videocodering en YouTube-publicatie controleren](#monitoring-video-encoding-and-youtube-publishing-progress). Als u Dynamic Media hebt ingeschakeld en Video Cloud-services hebt ingesteld, **[!UICONTROL Dynamic Media Encode Video]** de workflow wordt automatisch van kracht wanneer u een video uploadt. (Als u Dynamic Media niet gebruikt, wordt **[!UICONTROL DAM Update Asset]** workflow wordt van kracht.)
...
### Primaire bronvideobestanden {#source-video-files}
...
* **Codering van constante bitsnelheid** (CBR) - Tijdens CBR-codering blijft de bitsnelheid of het aantal bits per seconde tijdens het coderingsproces ongewijzigd. Bij CBR-codering blijft de gegevenssnelheid van de set behouden voor de instelling van de gehele video. Bij CBR-codering worden mediabestanden niet geoptimaliseerd voor kwaliteit, maar wordt opslagruimte bespaard.
   ...
   Gebruik CBR als uw video een vergelijkbaar bewegingsniveau in de gehele video bevat. CBR wordt meestal gebruikt voor het streamen van video-inhoud. Zie ook [Parameters voor videocodering met aangepaste toevoeging gebruiken](video-profiles.md#using-custom-added-video-encoding-parameters).
...
1. [(Optioneel) Controleer de gepubliceerde video op YouTube](video.md#optional-verifying-the-published-video-on-youtube)
...
1. Tik op de pagina Google Cloud Platform boven in het scherm op **[!UICONTROL Console]**. U kunt **Aanmelden** met uw Google-accountgegevens.
1. Op de **[!UICONTROL Dashboard]** pagina, tikken **[!UICONTROL Create Project]**.
1. In de **[!UICONTROL New Project]** , voert u een projectnaam in.
...
1. Op de **[!UICONTROL Dashboard]** in de **[!UICONTROL Getting Started]** kaart, tikken **[!UICONTROL Enable APIs and get credentials like keys]**.
1. Boven aan **[!UICONTROL Dashboard]** pagina, tikken **[!UICONTROL Enable API]**.
1. Op de **[!UICONTROL Library]** pagina, onder YouTube API&#39;s, tikken **[!UICONTROL YouTube Data API]**.
1. Boven aan **[!UICONTROL YouTube Data API v3]** pagina, tikken **[!UICONTROL Enable]** om deze in te schakelen.
...
1. Onder **[!UICONTROL What data will you be accessing?]** selecteren **[!UICONTROL User data]**.
1. Tikken **[!UICONTROL What credentials do I need?]** knop.
1. Onder de **[!UICONTROL Create an OAuth 2.0 client ID]** voert u een unieke naam in.
1. In het tekstveld onder de **[!UICONTROL Authorized Javascript origins]** de kop, gaat het volgende weg in, vervangt uw eigen domein en havenaantal in de weg, dan drukt **[!UICONTROL Enter]** om het pad aan de lijst toe te voegen:
...
1. In het tekstveld onder de **[!UICONTROL Authorized redirect URIs]** Voer de volgende optie in, vervang uw eigen domein- en poortnummer in het pad en druk vervolgens op Enter om het pad aan de lijst toe te voegen:
...
1. Op de pagina Credentials, onder de **[!UICONTROL Set up the OAuth 2.0 consent screen]** Selecteer het Gmail-adres dat u momenteel gebruikt.
1. In het tekstveld onder de **[!UICONTROL Product name shown to users]** voert u in wat u wilt weergeven op het instemmingsscherm.
...
1. Onder de **[!UICONTROL Download credentials]** kop, tikken **[!UICONTROL Download]**.
...
1. Tik in de rechterbovenhoek van de YouTube-pagina op uw profielfoto (kan ook als een letter in een cirkel met effen kleuren worden weergegeven) en tik vervolgens op **[!UICONTROL YouTube settings]** (rondtandwielpictogram).
1. Op de **[!UICONTROL Overview]** pagina, onder de **[!UICONTROL Additional Features]** kop, tikken **[!UICONTROL See all my channels or create a new channel]**.
1. Op de **[!UICONTROL Channels]** pagina, tikken **[!UICONTROL Create a new channel]**.
1. Op de **[!UICONTROL Brand Account]** pagina, in de **[!UICONTROL Brand Account Name]** veld, voer een bedrijfsnaam of een andere kanaalnaam in die u kiest waar u de video-elementen wilt publiceren en tik vervolgens op **[!UICONTROL Create]**.
...
Als u video&#39;s naar YouTube wilt publiceren, AEM tags aan een of meer YouTube-kanalen gekoppeld. Als u tags wilt toevoegen voor publicatie, raadpleegt u [Tags beheren](/help/sites-administering/tags.md).

Of als u de standaardlabels in AEM wilt gebruiken, kunt u deze taak overslaan en naar [De YouTube-publicatiereplicatieagent inschakelen](#enabling-the-youtube-publish-replication-agent).
...
1. Op de **[!UICONTROL Agents of Author]** pagina, tikken **[!UICONTROL YouTube Publish (youtube)]**.
1. Tik op de werkbalk rechts van Instellingen op **[!UICONTROL Edit]**.
1. Selecteer **[!UICONTROL Enabled]** checkbox om de replicatieagent aan te zetten.
1. tikken **[!UICONTROL OK]**.
...
1. Onder de **[!UICONTROL Third Party Services]** kop, onder YouTube, tikken **[!UICONTROL Configure now]**.
1. In de **[!UICONTROL Create Configuration]** voert u in de desbetreffende velden een titel (verplicht) en een naam (optioneel) in.
1. Tik op **[!UICONTROL Create]**.
1. In de **[!UICONTROL YouTube Account Settings]** in het dialoogvenster **[!UICONTROL Application Name]** voert u de Google-project-id in.

   U hebt de project-id opgegeven toen u de Google Cloud-instellingen voor het eerst eerder hebt geconfigureerd.

   Laat de **[!UICONTROL YouTube Account Setting]** geopend dialoogvenster; daar kom je zo op terug .
...
1. Terugkeren naar de **[!UICONTROL YouTube Account Settings]** in. Plak de JSON-tekst in het veld **[!UICONTROL JSON Config]**.
1. Tik op **[!UICONTROL OK]**.

   U stelt nu YouTube-kanalen in AEM.

1. Aan het recht van **[!UICONTROL Available Channels]**, tikken **[!UICONTROL +]** (plusteken).
1. In de **[!UICONTROL YouTube Channel Settings]** in het dialoogvenster **[!UICONTROL Title]** veld, voert u de naam in van het kanaal dat u in de taak hebt gemaakt **C[!UICONTROL reating a YouTube channel]** eerder.
...
1. **Codes instellen voor publicatie** - over de **[!UICONTROL Cloud Services > YouTube]** pagina, tikt u op de **[!UICONTROL Pencil]** om de lijst met tags te bewerken die u wilt gebruiken.
...
1. Op de **[!UICONTROL Metadata Schema Editor]** pagina, tikt u op de **[!UICONTROL Advanced]** tab.
...
1. Aan de rechterkant van de pagina, onder de **[!UICONTROL Settings]** doet u het volgende:
   ...
   * In de **[!UICONTROL Field Label]** tekstveld, selecteer en kopieer de waarde.
...
1. In de rechterbovenhoek van het dialoogvenster **[!UICONTROL Metadata Schema Editor]** pagina, tikken **[!UICONTROL Cancel]**.
...
1. Op de **[!UICONTROL Metadata Profiles]** pagina, bij de rechterbovenhoek van de pagina, tikken **[!UICONTROL Create]**. In de **[!UICONTROL Add Metadata Profile]** in het dialoogvenster **[!UICONTROL Profile title]** tekstveld, voer de naam in `YouTube Video`.
1. Op de **[!UICONTROL Metadata Profile Editor]** pagina, tikt u op de **[!UICONTROL Advance]** tab.
1. Voeg de gekopieerde YouTube Publishing-waarden als volgt toe aan het profiel:

   * Tik rechts op de pagina op de knop **[!UICONTROL Build Form]** tab.
   * Sleep de component met het label **[!UICONTROL Section Header]** naar links en neer in het formuliergebied.
   * Tikken **[!UICONTROL Field Label]** om de component te selecteren.
   * Aan de rechterkant van de pagina, onder de **[!UICONTROL Settings]** tabblad, in het dialoogvenster **[!UICONTROL Field Label]** tekstveld, typ `YouTube Publishing`.
   * Tik op de knop **[!UICONTROL Build Form]** en sleep de component met het label **[!UICONTROL Single Line Text]** en laat het onder de **[!UICONTROL YouTube Publishing]** koptekst die u zojuist hebt gemaakt.
   * Tikken **[!UICONTROL Field Label]** om de component te selecteren.
   * Aan de rechterkant van de pagina, onder de **[!UICONTROL Settings]** plakken, **[!UICONTROL YouTube Publishing]** waarden (**[!UICONTROL Field Label]** waarde en **[!UICONTROL Map to property]** waarde) die u eerder hebt gekopieerd, naar de desbetreffende velden op het formulier. Plak de **[!UICONTROL Choices]** in de **[!UICONTROL Default Value]** veld.
...
1. Voeg de gekopieerde YouTube-privacywaarden als volgt toe aan het profiel:
   ...
   * Tik op de knop **[!UICONTROL Build Form]** en sleep de component met het label **[!UICONTROL Single Line Text]** en laat het onder de **[!UICONTROL YouTube Privacy]** koptekst die u zojuist hebt gemaakt.
   * Tikken **[!UICONTROL Field Label]** om de component te selecteren.
   * Aan de rechterkant van de pagina, onder de **[!UICONTROL Settings]** plakken, **[!UICONTROL YouTube Publishing]** waarden (**[!UICONTROL Field Label]** waarde en **[!UICONTROL Map to property]** waarde) die u eerder hebt gekopieerd, naar de desbetreffende velden op het formulier. Plak de **[!UICONTROL Choices]** in de **[!UICONTROL Default Value]** veld.
...
Als AEM inhoud uit YouTube wilt publiceren, gebruikt u de opdracht **[!UICONTROL Publish to YouTube]** werkstroom, waarmee u de voortgang kunt controleren en eventuele foutgegevens kunt bekijken.
...
1. Tik op de werkbalk op **[!UICONTROL Properties]**.
1. In de **[!UICONTROL Basic]** , tikt u onder de kop Metagegevens op **[!UICONTROL Browse]** rechts van de **[!UICONTROL Tags]** veld.
1. Op de **[!UICONTROL Select Tags]** navigeer naar de gewenste tags en selecteer een of meer tags.
1. Tik in de rechterbovenhoek van de pagina op de knop **[!UICONTROL Confirm]** pictogram.
1. Tik in de rechterbovenhoek van de eigenschappenpagina van de video op **[!UICONTROL Save]**.
1. Tik op de werkbalk op **[!UICONTROL Publish > Publish]**.
...
Na acht uur als je nog steeds een statusbericht ziet dat **[!UICONTROL Uploaded (processing, please wait)]**, verwijder de video van onze site en upload deze opnieuw.
...
1. Onder de **[!UICONTROL YouTube Publishing]** in de **[!UICONTROL YouTube URL]** Maak een lijst, selecteer en kopieer de URL-tekst naar uw webbrowser om een voorvertoning van het element weer te geven of om deze aan uw pagina met webinhoud toe te voegen.
...
Als u inhoud uit YouTube wilt verwijderen, gebruikt AEM de **[!UICONTROL Unpublish from YouTube]** werkstroom, waarmee u de voortgang kunt controleren en eventuele foutgegevens kunt bekijken.
Zie [De voortgang van videocodering en YouTube-publicatie controleren](#monitoring-video-encoding-and-youtube-publishing-progress).

**Publiceren van video&#39;s ongedaan maken om deze uit YouTube te verwijderen:**

1. Tik in de linkerbovenhoek van AEM op het AEM-logo en tik vervolgens in de linkerspoorstaaf op **[!UICONTROL Tools]** > **[!UICONTROL Assets]**.
...
1. Tik op de werkbalk op **[!UICONTROL Unpublish]** > **[!UICONTROL Unpublish]**.
...
1. Voortgang videocodering weergeven in map met elementen:
   ...
   * In **[!UICONTROL Card View]** De voortgang van de videocodering wordt over het element weergegeven met een percentage. Als er een fout optreedt, wordt deze informatie ook weergegeven op het element.

      ![chlimage_1-429](assets/chlimage_1-429.png)

   * In **[!UICONTROL List View]**, wordt de voortgang van de videocodering weergegeven in de **[!UICONTROL Processing Status]** kolom. Als er een fout is, wordt dit bericht in dezelfde kolom weergegeven.

      ![chlimage_1-430](assets/chlimage_1-430.png)

      Deze kolom wordt niet standaard weergegeven. Selecteer **[!UICONTROL View Settings]** van de **[!UICONTROL Views]** en voegt u de **[!UICONTROL Processing Status]** kolom en tik **[!UICONTROL Update]**.

      ![chlimage_1-431](assets/chlimage_1-431.png)

1. De voortgang van de elementen weergeven. Als u op een element tikt, opent u het vervolgkeuzemenu en selecteert u **[!UICONTROL Timeline]**. Selecteer **[!UICONTROL Workflows]**.

   ![chlimage_1-432](assets/chlimage_1-432.png)

   Workflowinformatie zoals codering wordt weergegeven in de tijdlijn. Voor YouTube-publicatie **[!UICONTROL Workflow]** De tijdlijn bevat ook de naam van het YouTube-kanaal en de video-URL van YouTube. Bovendien ziet u foutmeldingen in het dialoogvenster **[!UICONTROL Workflow]** tijdlijn.

   >[!NOTE]
   >
   >Het kan lang duren voordat foutberichten of foutberichten definitief worden opgenomen omdat er meerdere workflowconfiguraties zijn **[!UICONTROL retries]**, **[!UICONTROL retry delay]**, en **[!UICONTROL timeout]** van [http://localhost:4502/system/console/configMgr](http://localhost:4502/system/console/configMgr), bijvoorbeeld:
   >
...
1. Zie voor werkstromen die worden uitgevoerd **Workflowinstanties** beschikbaar via **[!UICONTROL Tools > Workflow > Instances]**.

   >[!NOTE]
   >
   >Mogelijk hebt u beheerdersrechten nodig voor toegang tot de **[!UICONTROL Tools]** -menu.
   ...
   Van de **[!UICONTROL Workflow Instances]** kunt u werkstromen ook onderbreken, beëindigen of hernoemen. Zie [Workflows beheren](/help/sites-administering/workflows-administering.md) voor meer informatie .

1. Voor mislukte taken raadpleegt u **Workflowfouten** beschikbaar via **[!UICONTROL Tools > Workflow > Failures]**. De lijst **[!UICONTROL Workflow Failure]** bevat alle mislukte workflowactiviteiten.
   ...
   >[!NOTE]
   >
   >Het kan lang duren voordat het foutbericht eindelijk is opgenomen omdat er meerdere workflowconfiguraties zijn **[!UICONTROL retries]**, **[!UICONTROL retry delay]**, en **[!UICONTROL timeout]** van [http://localhost:4502/system/console/configMgr](http://localhost:4502/system/console/configMgr), bijvoorbeeld:
   >
   >* Configuratie Apache Sling-taakwachtrij
   >* Adobe Granite-workflow - Externe verwerking van taken
   >* Tijdelijke wachtrij voor Granite Workflow
...
1. Voor voltooide workflows raadpleegt u **[!UICONTROL Workflow Archive]** beschikbaar via **[!UICONTROL Tools > Workflow > Archive]**. In **[!UICONTROL Workflow Archive]** vindt u een lijst met alle voltooide workflowactiviteiten.
...
Zie [E-mailberichten configureren](#configuring-e-mail-notifications).
...
* Voor coderingstaken hebt u toegang tot de configuratiepagina voor alle e-mailmeldingen over AEM workflow op **[!UICONTROL Tools > Operations > Web Console]** en door te zoeken naar **[!UICONTROL Day CQ Workflow Email Notification Service]**. Zie [E-mailmelding configureren in AEM](/help/sites-administering/notification.md). U kunt de selectievakjes voor **[!UICONTROL Notify on Abort]** of **[!UICONTROL Notify on Complete]** dienovereenkomstig.

* Ga als volgt te werk voor publicatietaken in YouTube:

1. Selecteer in AEM **[!UICONTROL Tools]** > **[!UICONTROL Workflow]** > **[!UICONTROL Models]**.
1. Selecteer **[!UICONTROL Publish to YouTube]** workflow, tikken **[!UICONTROL Edit]**.
1. Klik met de rechtermuisknop op de knop **[!UICONTROL YouTube Upload]** workflowstap, en tik vervolgens op **[!UICONTROL Edit]**.
1. Tik op de knop **[!UICONTROL Argument]s** tab.
...
1. Tik in de linkerbovenhoek van AEM op het AEM-logo en tik vervolgens in de linkerspoorstaaf op **[!UICONTROL Tools]** > **[!UICONTROL Assets]** > **[!UICONTROL Video Reports]**.
1. Voer een van de volgende handelingen uit op de pagina Videorapporten:

   * Tik in de rechterbovenhoek op de knop **[!UICONTROL Refresh Video Report]** pictogram.
   ...
   * Tik in de rechterbovenhoek op de knop **[!UICONTROL Date Picker]** pictogram.

      Geef het begin- en einddatumbereik op waarvoor u videogegevens wilt en tik vervolgens op **[!UICONTROL Run Report]**.
   De **[!UICONTROL Top Metrics]** groepsvak identificeert diverse geaggregeerde metingen voor alle *gepubliceerd* video&#39;s op uw site.
...
Gebruik de [Adobe Dynamic Media Viewers Reference Guide](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/homeviewers.html) en de [HTML5 Viewer SDK API](https://s7d1.scene7.com/s7sdk/3.10/docs/jsdoc/index.html) om uw eigen videoviewers te maken.
...
1. U kunt een toepassing of service van derden gebruiken om een ondertitelingsbestand of ondertitelingsbestand voor video te maken.
   ...
   In het hulpmiddel, in **[!UICONTROL Enter URL of video file]** veld, plak de gekopieerde URL van het videobestand en tik vervolgens op **[!UICONTROL Load]**. Zie [Een URL verkrijgen voor een asset](linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset) om de URL naar het videobestand zelf op te halen, die u vervolgens in het **[!UICONTROL Enter URL of video file field]** kunt plakken. Internet Explorer, Chrome of Safari kunnen de video vervolgens op een native manier afspelen.
...
1. Voer een van de volgende handelingen uit:
   ...
   * Tik op **[!UICONTROL Embed Code]**. Selecteer in het dialoogvenster Code insluiten de insluitcode en kopieer deze naar het klembord en plak de code in een eenvoudige teksteditor. Voeg de gekopieerde insluitcode toe met de volgende syntaxis:
...
1. Sla de `.vtt` bestand in UTF8-codering om problemen met tekenuitvoering in de hoofdstuktiteltekst te voorkomen.
   ...
   <table> 
     <tbody> 
      <tr> 
       ...
       <li>Tik vervolgens in de vervolgkeuzelijst op <strong>Viewers</strong>.</li> 
       ...
       <li>Tik in de linkerspoorstaaf onderaan <strong>URL</strong>.</li> 
      ...
      <tr> 
       ...
       <li>Tik vervolgens in de vervolgkeuzelijst op <strong>Viewers</strong>.</li> 
       <li>Tik in de linkertrack op de naam van de voorinstelling voor de videoviewer. Er wordt een voorvertoning van de video geopend op een aparte pagina.</li> 
       <li>Tik in de linkerspoorstaaf onderaan <strong>Insluiten</strong>.</li> 
...
1. In de modus voor selectie van elementen **[!UICONTROL List View]** of de **[!UICONTROL Card View]** tikt u op het video-element.
1. Tik op de werkbalk op de knop **[!UICONTROL View Properties]** pictogram (een cirkel met een &quot;i&quot; erin).
1. Op de video&#39;s **[!UICONTROL Properties]** pagina, tikken **[!UICONTROL Change Thumbnail]**.
1. Op de **[!UICONTROL Change Thumbnail]** pagina, tikt u op de werkbalk op **[!UICONTROL Select Frame]**.
...
1. In het deelvenster rechtsonder in het dialoogvenster **[!UICONTROL Properties]** tab, dubbeltikken `thumbnailtime`.
...
1. Tikken **[!UICONTROL OK]** om terug te keren naar de **[!UICONTROL Properties]** tab.
1. Tik in de linkerbovenhoek van de pagina CRXDE Lite op **[!UICONTROL Save All]** Tik vervolgens op de knop **[!UICONTROL Back Home]** in de linkerbovenhoek om terug te keren naar AEM.
...
1. Tik op de werkbalk op de knop **[!UICONTROL View Properties]** pictogram (een cirkel met een &quot;i&quot; erin).
1. Op de video&#39;s **[!UICONTROL Properties]** pagina, tikken **[!UICONTROL Change Thumbnail]**.
1. Op de **[!UICONTROL Change Thumbnail]** pagina, tikt u op de werkbalk op **[!UICONTROL Upload New Thumbnail]**.
1. Navigeer naar een miniatuurafbeelding die u wilt gebruiken, selecteer deze en tik vervolgens op **[!UICONTROL Open]** om te beginnen met het uploaden van de afbeelding naar AEM
1. Nadat de afbeelding is geüpload, kunt u in het dialoogvenster **[!UICONTROL Change Thumbnail]** pagina, tikken **[!UICONTROL Save Changes]**.
