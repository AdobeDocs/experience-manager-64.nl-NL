...
* **Gekoppelde inhoud**
   ...
   * De activa worden [verbonden aan fragmenten via inzamelingen](content-fragments-assoc-content.md); Met gekoppelde verzamelingen kan de auteur beslissen welke elementen worden gebruikt wanneer deze de pagina ontwerpt.
      ...
      * [Elementen (DAM) Verzamelingen](managing-collections-touch-ui.md) vormen de basis voor de bijbehorende inhoud van fragmenten.
...
* **Inhoudsmodel**
   ...
   * Wordt [ingeschakeld en gemaakt met de gereedschappen](content-fragments-models.md).
   * Vereist voor het [maken van een gestructureerd fragment](content-fragments-managing.md#creating-content-fragments).
