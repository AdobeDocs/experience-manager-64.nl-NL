...
Voor de integratie is een Adobe Stock- [ondernemingsplan](https://stockenterprise.adobe.com/) en [!DNL Experience Manager] 6.4 met ten minste Service Pack 2 geïmplementeerd vereist. Voor [!DNL Experience Manager] 6.4 de details van het de dienstpak, zie deze [versienota&#39;s](/help/release-notes/sp-release-notes.md).
