...
* Selecteer actief kopiëren en zoek de informatie op de pagina **[!UICONTROL Eigenschappen]** .
...
Nadat een bron is gewijzigd, kunnen de wijzigingen aan de live kopieën worden doorgegeven met behulp van een synchronisatiehandeling of een rollout-handeling. Zie de [verklarende woordenlijst](#glossary-msm-for-assets)voor meer informatie over het verschil tussen beide handelingen.
...
1. Selecteer een actief exemplaar of een map voor live kopiëren. Klik op **[!UICONTROL Eigenschappen]** op de werkbalk. U kunt ook de sneltoets gebruiken `p`.
1. Klik op Bron **[!UICONTROL van]** Live kopie. Klik op **[!UICONTROL Uitvoeren]** op de werkbalk.
1. Selecteer de live kopieën die u wilt bijwerken. Klik op **[!UICONTROL Uitvoeren]**.
1. Om de updates uit te voeren die aan de kindactiva worden gemaakt, selecteer Bron **[!UICONTROL Rollout en alle Kinderen]**.
...
|---|---|---|
| [!UICONTROL Referenties] spoorstaaf | Snel synchroniseren wanneer de bron al is geselecteerd. | Zie [Snelle acties van References rail voor bron](#quick-actions-from-references-rail-for-source) |
| Werkbalk op de pagina [!UICONTROL Eigenschappen] | Een synchronisatie starten wanneer u de live kopieereigenschappen al hebt geopend. | Zie Een live kopie [synchroniseren](#synchronize-live-copy) |
| [!UICONTROL Live Copy Overview] -console | Synchroniseer snel meerdere elementen (niet noodzakelijkerwijs alle) wanneer de bronmap is geselecteerd of de [!UICONTROL Live Copy-overzichtsconsole] al is geopend. De synchronisatiehandeling wordt gestart voor één element tegelijk, maar is een snellere manier om te synchroniseren voor meerdere middelen in één keer. | Zie [Handelingen voor veel elementen in een live-kopieermap](#take-actions-on-many-assets-in-lcfolder) |
...
>[!NOTE]
>
>Als de relatie wordt onderbroken, is de synchronisatiehandeling niet beschikbaar op de werkbalk. Hoewel synchroniseren beschikbaar is in de [!UICONTROL Verwijzingen] per spoor, worden de wijzigingen niet doorgevoerd, zelfs niet na een naar verluidt geslaagde uitrol.
...
1. Selecteer een actief of map voor live kopiëren. Klik op **[!UICONTROL Eigenschappen]** op de werkbalk. U kunt ook de sneltoets p gebruiken.
