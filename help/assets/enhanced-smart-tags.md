...
Op de achtergrond gebruikt de Smart Content Service het AI-framework van Adobe Sensei om het algoritme voor beeldherkenning op te leiden voor uw tagstructuur en bedrijftaxonomie. Deze inhoudsinfo wordt vervolgens gebruikt om relevante tags toe te passen op een andere set elementen.
...
1. Selecteer op de pagina **[!UICONTROL Elementrapporten]** het rapport dat u hebt gegenereerd. Tik op of klik op het pictogram **[!UICONTROL Weergave]** op de werkbalk om het rapport weer te geven.
...
1. Als u het rapport wilt downloaden, selecteert u het in de lijst en tikt u op het pictogram **[!UICONTROL Downloaden]** op de werkbalk of klikt u erop. Het rapport wordt gedownload als Excel-bestand.
...
1. Tik/klik op de pijl onderaan en tik/klik op Workflow **** starten.
