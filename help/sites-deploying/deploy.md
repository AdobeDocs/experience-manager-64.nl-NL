...
* [Upgrade naar AEM 6.4](/help/sites-deploying/upgrade.md)
...
* **Webtoepassingsserver**: AEM kunnen in zelfstandige modus worden geïmplementeerd (inclusief een geïntegreerde Jetty-webserver) of als een webtoepassing binnen een toepassingsserver van een derde (WebLogic, WebSphere, enz.).
...
**Snellere marktintroductie:** Met de flexibele cloudinfrastructuur van Adobe Managed Services kunnen organisaties snel succesvolle digitale ervaringen plannen, lanceren en optimaliseren. Adobe beheert de cloudarchitectuur zonder extra kapitaal, hardware of software vereist en Adobe Success-technici, hulp met AEM architectuur, provisioning, aanpassing voor het maken van verbinding met back-end apps en &#39;go-live&#39; best practices.
...
Voor meer informatie over Cloud Manager en de bijbehorende bronnen raadpleegt u [**Gebruikershandleiding voor Cloud Manager**](https://helpx.adobe.com/experience-manager/cloud-manager/user-guide.html).
...
Op de client werkt AEM met alle moderne browsers (**Microsoft Edge**, **Internet Explorer** 11 **Chroom** 51+ , **Firefox** 47+, **Safari** 8+) op zowel desktop als tablet besturingssystemen. Zie [Ondersteunde client-Platforms](/help/sites-deploying/technical-requirements.md#supported-client-platforms) voor meer informatie.
...
* **cq-quickstart-6.4.0.jar:** Een zelfstandig uitvoerbaar bestand *jar* een bestand dat alles bevat wat nodig is om aan de slag te gaan.

* **cq-quickstart-6.4.0.war:** A *oorlog* bestand voor implementatie op een externe toepassingsserver.
...
1. Als u de instantie wilt starten in een GUI-omgeving, dubbelklikt u op de knop **`cq-quickstart-6.4.0.jar`** bestand.
