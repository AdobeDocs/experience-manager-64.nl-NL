...
Raadpleeg [**Handleiding voor cloudbeheer**](https://helpx.adobe.com/experience-manager/cloud-manager/user-guide.html) voor meer informatie over Cloud Manager en de bijbehorende bronnen.
...
Aan de clientzijde werkt AEM met alle moderne browsers (**Microsoft Edge**, **Internet Explorer** 11, **Chrome** 51+, **Firefox** 47+, **Safari** 8+) op zowel het bureaublad als het werktablet systemen. Zie [Ondersteunde client-Platforms](/help/sites-deploying/technical-requirements.md#supported-client-platforms) voor meer informatie.
...
* **cq-quickstart-6.4.0.jar:** Een standalone uitvoerbaar  ** jarfile dat alles omvat nodig om op en uit te komen.

* **cq-quickstart-6.4.0.war:** Een  ** warfile voor plaatsing in een derdetoepassingsserver.
...
1. Plaats de **jar** en **license** dossiers in deze folder:
...
1. Als u de instantie wilt starten in een GUI-omgeving, dubbelklikt u op het bestand **`cq-quickstart-6.4.0.jar`**.
