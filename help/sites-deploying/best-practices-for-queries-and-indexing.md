...
>[!NOTE]
>
>In AEM 6.4 is [eak-run.jar de ENIGE ondersteunde methode](/help/sites-deploying/indexing-via-the-oak-run-jar.md#reindexingapproachdecisiontree) voor het opnieuw indexeren op MongoMK- of RDBMK-opslagruimten.
