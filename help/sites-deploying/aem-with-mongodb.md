...
Voor meer informatie over MongoDB Cloud Manager raadpleegt u de [MongoDB-documentatie](https://docs.mongodb.com/).
...
Raadpleeg de volgende handleiding voor documentatie over het instellen van MongoDB met Amazon Web Services [MongoDB op AWS](https://docs.aws.amazon.com/quickstart/latest/mongodb/welcome.html).
...
Als AEM wordt uitgevoerd op een implementatie van de persistentiebeheersoftware van MongoMK, [paginanamen mogen maximaal 150 tekens bevatten](/help/sites-authoring/managing-pages.md#page-name-restrictions-and-best-practices).
