...
Als u de upgrade wilt uitvoeren, is het belangrijk dat u AEM start met het jar-bestand om de instantie te tonen. Voor een upgrade naar 6.4 kunt u ook andere opties voor het herstructureren van inhoud en migratie bekijken in [Lazy Content Migration](/help/sites-deploying/lazy-content-migration.md) die u kunt kiezen met de upgradeopdracht.
