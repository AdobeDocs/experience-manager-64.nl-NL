...
Bijvoorbeeld als een instantie met de looppaswijzen was begonnen `author,dev,emea`, en zowel `/apps/*/config.author/` als een configuratie `/apps/*/config.emea.author/` bepalen voor\
