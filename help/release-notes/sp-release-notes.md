...
| URL downloaden | AEM 6.4.7.0 op [PackageShare](https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq640/servicepack/AEM-6.4.7.0) |

## Wat is inbegrepen in AEM 6.4.7.0 {#what-s-included-in-aem}
...
#### Documentservices voor OSGi {#document-services-osgi}
...
* De rijke tekstredacteur wordt onbruikbaar wanneer geschakeld van volledig scherm aan het drijven dialoog. De zwevende weergave bevat twee teksteditors met tekstopmaak. NPR-25589: Hotfix voor CQ-4206008
...
* Wijzigingen voor het afbreken van de API export.json herstellen. Hotfix voor CQ-4251854
...
* Kan de OTB AEM-formuliercomponent niet gebruiken vanwege een inefficiënte query. NPR-25065: Hotfix voor CQ-4247256
...
* AEM 6.4.7.0 vereist AEM 6.4. Ga naar de [upgradedocumentatie](../sites-deploying/upgrade.md) voor gedetailleerde instructies.
...
* Voor een plaatsing met MongoDB en veelvoudige instanties, installeer AEM 6.4.7.0 op één van de instanties van de Auteur gebruikend de Manager van het Pakket.
...
>[!NOTE]
>
>Adobe raadt u niet aan het pakket AEM 6.4.7.0 te verwijderen of te verwijderen.
...
1. Meld u aan bij Delen via pakket in AEM of rechtstreeks vanuit uw browser en download het pakket AEM 6.4.7.0.

   (zoek naar &quot;AEM-6.4.7.0&quot; om het te vinden)
1. Installeer het gedownloade pakket met Package Manager.

>[!NOTE]
>
>**Dialoogvenster over de interface van de Manager van het Pakket sluit soms ongeschikt tijdens installatie van 6.4.7.0 af**
>
...
Er zijn twee manieren om AEM 6.4.7.0 in een lopende instantie automatisch te installeren:
...
>[!NOTE]
>
>AEM 6.4.7.0 ondersteunt geen Bootstrap-installatie.

### Installatie valideren {#validate-install}

1. Op de pagina Productinformatie (*/system/console/productinfo *) wordt nu de bijgewerkte versie weergegeven van de tekenreeks &quot;Adobe Experience Manager, versie 6.4.7.0&quot; onder Geïnstalleerde producten.
...
<p id="Dynamic">AEM 6.4.7.0 bevat een nieuwe versie van Dynamic Media-viewers (5.10.1), waarmee u kunt controleren op dubbele namen op een pagina met voorinstellingen voor afbeeldingen. Klanten met dynamische media wordt aangeraden de volgende opdracht uit te voeren om voorinstellingen van de viewer voor selectievakjes naar een actuele status over te brengen.
...
>[!NOTE]
>
>AEM 6.4.7.0 bevat een nieuwe versie van het compatibiliteitspakket [voor](https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq640/compatpack/AEM-FORMS-6.4.7.0-COMPAT)AEM-formulieren. Als u een oudere versie van AEM Forms Compatibility Package gebruikt en een update naar AEM 6.4.7.0 uitvoert, installeert u de meest recente versie van AEM Forms Compatibility Package na de installatie van Forms Add-On Package.
...
Zie [AEM Forms JEE Patch Installer 0013 voor informatie over de installatie van het cumulatieve installatieprogramma voor AEM Forms JEE en de configuratie na de implementatie](https://helpx.adobe.com/aem-forms/quick-fixes/6-4/jee-patch-0013.html).
...
De Uber Jar voor AEM 6.4.7.0 is beschikbaar in de [openbare gegevensopslagplaats](https://repo.adobe.com/nexus/content/groups/public/com/adobe/aem/uber-jar/6.4.7/)van Adobe.
...
De volgende tekstdocumenten maken een lijst van de bundels OSGi en de Pakketten van de Inhoud inbegrepen in AEM 6.4.7.0.

Lijst van OSGi-bundels opgenomen in AEM 6.4.7.0

[Bestand ophalen](assets/6.4.7.0_osgi_bundles.txt)

Lijst met inhoudspakketten die zijn opgenomen in AEM 6.4.7.0

[Bestand ophalen](assets/sp_6.4.7.0_content_packages.txt)
