...
>
>Zie [Vereisten voor Integratie met Adobe Target](/help/sites-administering/target-requirements.md) voor meer informatie.
...
1. Selecteer de activiteit en klik of tik **Eigenschappen van de Mening **en klik het lusje van **Rapporten** en selecteer de activiteit die u prestaties voor wilt bekijken/het winnen ervaringen voor omzetten. Prestatiegegevens worden weergegeven.

   ![chlimage_1-239](assets/chlimage_1-239.png)

1. Klik of tik op de koppeling **** Push-winnaar om die ervaring standaard te gebruiken.
