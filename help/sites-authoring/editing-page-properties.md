...
* **Alias**
   ...
   >
   >Zie [Gelokaliseerde paginanamen onder SEO en URL Management Best Practices voor meer informatie](/help/managing/seo-and-url-management.md#localized-page-names)

* **Toegestane sjablonen**

   [Definieer de lijst met sjablonen die beschikbaar](/help/sites-authoring/templates.md#enabling-and-allowing-a-template-template-author) zijn in deze subvertakking.
