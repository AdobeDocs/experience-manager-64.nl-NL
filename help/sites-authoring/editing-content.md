...
1. [Bewerken](#edit-configure-copy-cut-delete-paste) de component.
...
Als u bij het bladeren in de elementen opmerkt dat u snel een wijziging in een element moet aanbrengen, kunt u het dialoogvenster [middeleneditor](/help/assets/managing-assets-touch-ui.md) rechtstreeks vanuit de browser door op het pictogram Bewerken naast de naam van het element te klikken.
...
* [Middelen slepen en neerzetten](#inserting-a-component-using-the-assets-browser) vanuit de middelenbrowser om rechtstreeks inhoud toe te voegen.
