...
1. Als u een ervaring wilt toevoegen, klikt u of tikt u op **+ Toevoeging Ervaring richten** dat hieronder de bestaande ervaringen in het **Soorten publiek** venster.
...
Selecteren **ContextHub** als motor als u ContextHub voor het richten gebruikt. Zie [ContextHub configureren.](/help/sites-administering/contexthub-config.md)
