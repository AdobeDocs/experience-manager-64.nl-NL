...
>[!CAUTION]
>
>Deze pagina moet worden gelezen in combinatie met [Werken met inhoudsfragmenten](/help/assets/content-fragments.md) (en verwante pagina&#39;s), aangezien deze basisterminologie en -concepten introduceert en fragmenten maakt en beheert.
...
1. Voeg de **[!UICONTROL Content Fragment]** onderdeel; van **[!UICONTROL Components]** browser of **[!UICONTROL Insert New Component]**.

1. U kunt:

   * Open de **[!UICONTROL Assets]** browser en filter voor **[!UICONTROL Content Fragments]** (de standaardwaarde is Afbeeldingen). Sleep het gewenste fragment vervolgens naar de componentinstantie.
   * Selecteer vervolgens de inhoudfragment-component **[!UICONTROL Configure]** op de werkbalk. In het dialoogvenster kunt u het dialoogvenster Selectie openen waarin u de vereiste **[!UICONTROL Content Fragment]**.
...
1. De inhoud van de **[!UICONTROL Main]** Element en **[!UICONTROL Master]** (variatie) wordt weergegeven. U kunt [andere elementen en/of variaties selecteren](#selecting-the-element-or-variation) zoals vereist.
...
De fragmentinstellingen openen **[!UICONTROL Configuration]** om het fragment te configureren voor gebruik op de huidige pagina. Het dialoogvenster kan afhankelijk zijn van de gebruikte component.
...
U kunt de fragmentbron openen voor bewerking (het element) met de opdracht **[!UICONTROL Edit]** op de werkbalk van de component. Hierdoor kunt u [het inhoudsfragment bewerken en beheren](/help/assets/content-fragments.md).
...
Wanneer een specifiek inhoudsfragment aan de pagina wordt toegevoegd, is er een **[!UICONTROL Drag components here]** tijdelijke aanduiding tussen elke HTML-alinea (en boven/onder) van het fragment.

Zo kunt u extra inhoud toevoegen [tussenliggend (d.w.z. tussen inhoud)](/help/assets/content-fragments.md#in-between-content-when-page-authoring-with-content-fragments) de fragmentinhoud (op een van de beschikbare punten), zonder dat u het basisfragment hoeft te wijzigen.
...
>[!NOTE]
>
>Er zijn verschillende methoden om toe te voegen [visuele elementen (bv. afbeeldingen)](/help/assets/content-fragments.md#fragments-with-visual-assets) op het fragment en/of de pagina.

>[!NOTE]
>
>Als u meerdere inhoudsfragmenten op één pagina hebt, kunt u **[!UICONTROL Associated Content]** worden de elementen weergegeven die geschikt zijn voor alle fragmenten.

Nadat u een fragment met de bijbehorende inhoud aan de pagina hebt toegevoegd, wordt een nieuw tabblad toegevoegd (**[!UICONTROL Associated Content]**) wordt geopend in het zijpaneel.
...
Indien [elementen (bijvoorbeeld afbeeldingen) zijn in het fragment zelf ingevoegd](/help/assets/content-fragments-variations.md#inserting-assets-into-your-fragment)De opties voor het bewerken van deze elementen in de pagina-editor zijn beperkt.
...
* Een fragment kan na [het fragment maken in de middelenconsole](/help/assets/content-fragments-managing.md#publishing-and-referencing-a-fragment).
