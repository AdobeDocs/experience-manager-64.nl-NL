...
Deze workflow wordt beschreven in [Een workflow voor een bestemmingspagina maken](/help/sites-authoring/projects-with-workflows.md#request-landing-page-workflow).
