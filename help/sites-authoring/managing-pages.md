...
Deze structuur kan worden weergegeven vanuit de **Sites** -console, waar u door de pagina&#39;s van uw website [kunt](/help/sites-authoring/basic-handling.md#product-navigation) navigeren en acties op de pagina&#39;s kunt uitvoeren. U kunt ook nieuwe sites en [nieuwe pagina&#39;s](#creating-a-new-page)maken.
...
Nadat u een pagina hebt gemaakt en geopend, kunt u inhoud [toevoegen met de componenten](/help/sites-authoring/editing-content.md#inserting-a-component)die beschikbaar zijn in de [deelbrowser](/help/sites-authoring/author-environment-tools.md#components-browser).
...
1. De pagina wordt geopend en u kunt de pagina [naar wens](/help/sites-authoring/editing-content.md) bewerken.
...
1. Als de pagina is gekoppeld aan of wordt verwezen naar, worden deze verwijzingen weergegeven in de stap **Aanpassen/Opnieuw** publiceren. U kunt aangeven welke gegevens moeten worden aangepast en opnieuw moeten worden gepubliceerd.
