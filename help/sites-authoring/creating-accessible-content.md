...
De **Alternatieve tekst** veld is beschikbaar in **Afbeelding** dialoogvenster van de component **Metagegevens** tab:
...
AEM vereist **Alternatieve tekst** veld dat standaard moet worden ingevuld. Als de afbeelding alleen decoratief is en alternatieve tekst onzinnig is, wordt de **Afbeelding is decoratief** Deze optie kan worden ingeschakeld.
...
* Illustratieve foto&#39;s: Dit zijn afbeeldingen van mensen, objecten of plaatsen. Denk na over de rol van de foto op de pagina. waarschijnlijk een geschikt tekstequivalent *Foto van [object]*, maar kan afhankelijk zijn van de omringende tekst.
...
AEM maakt het eenvoudig om webpagina&#39;s samen te stellen met de juiste HTML-elementen. Open de pagina-inhoud in de RTE (een tekstcomponent) en gebruik de component **Paraformat** (alineasymbool) om het juiste structuurelement (bijvoorbeeld alinea, kop, enz.) op te geven.
...
* **Lijsten gebruiken:** Met HTML kunt u drie verschillende typen lijsten opgeven:
   ...
   * De `<ol>` element is gebruikt voor *genummerde lijsten*. Afzonderlijke lijstitems worden geïdentificeerd aan de hand van de `<li>` element.
...
* **Tabellen gebruiken**:
   ...
   * a `<td>` element voor elke gegevenscel
   ...
   >[!NOTE]
   In de klassieke UI, zouden de lijsten met moeten worden gerealiseerd **Tabel** component.
...
* **Complexe gegevenstabellen:**
   ...
   >[!NOTE]
   In klassieke UI, zouden de lijsten met moeten worden gerealiseerd **Tabel** component.
...
* Onjuist voorbeeld:
   ...
   * Tekst: Klik voor meer informatie over onze avondlessen voor het najaar van 2010 op <u>hier</u>.
   * Reden: de bestemming ervan wordt niet duidelijk en ondubbelzinnig aangegeven.

* Goed voorbeeld:

   * Tekst: <u>Klassen voor najaar 2010</u> - nadere bijzonderheden.
...
* Als een pagina in het Engels (Engels) wordt geschreven, `<html>` Het element moet als volgt worden gelezen: `<html lang = “en-gb”>`
