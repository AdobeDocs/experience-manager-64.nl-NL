...
Ga voor meer informatie over het maken van het AEM Forms JEE-workflowproces naar [Workbench Help](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/WorkbenchHelp.pdf).
...
1. Een instantie van het publiek maken `ProcessManager` client ( `com.adobe.idp.workflow.client.ProcessManager`) met een `ServiceClientFactory` instantie met de juiste verbindingsinstellingen.
   ...
   Zie Java API-naslaggids voor meer informatie voor [Class ProcessManager](https://helpx.adobe.com/experience-manager/6-4/forms/ProgramLC/javadoc/com/adobe/idp/workflow/client/ProcessManager.html).
