...
Aangepaste formulieren, PDF forms en HTML5-formulieren installeren en configureren. Configureer Adobe Analytics en Adobe Target voor adaptieve formulieren om het gebruik van formulieren en doelgebruikers te analyseren op basis van hun profiel.
...
Voordat u begint met het installeren en configureren van AEM Forms voor het vastleggen van gegevens, moet u ervoor zorgen dat:
...
1. Voeg het **[!UICONTROL sun.util.calendar]** pakket toe aan het **[!UICONTROL allowlist]** veld. Klik op **[!UICONTROL Save]**.
