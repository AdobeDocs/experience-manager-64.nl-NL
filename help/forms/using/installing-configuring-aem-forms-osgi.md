...
1. Voeg de **[!UICONTROL sun.util.calendar]** aan de **[!UICONTROL allowlist]** veld. Klik op **[!UICONTROL Save]**.
...
1. Configureer de referentiefilterservice:
   ...
   Meld u als beheerder aan bij het configuratiebeheer van Apache Felix. De standaard-URL van het configuratiebeheer is `https://[server]:[port_number]/system/console/configMgr`. In de **[!UICONTROL Configurations]** selecteert u de **[!UICONTROL Apache Sling Referrer Filter]** optie. Voer in het veld Hosts toestaan de hostnaam van de verzender in om het als referentie toe te staan en klik op **[!UICONTROL Save]**. De opmaak van de vermelding is `https://[server]:[port]`.
