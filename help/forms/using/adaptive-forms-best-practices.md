...
U kunt de multi-sign ervaring van Acrobat Sign in adaptieve vormen gebruiken. Houd rekening met het volgende wanneer u Acrobat Sign in adaptieve formulieren configureert. Zie voor meer informatie [Acrobat Sign in een adaptieve vorm gebruiken](/help/forms/using/working-with-adobe-sign.md).

* Het adaptieve formulier dat geschikt is voor Acrobat Sign, wordt alleen verzonden nadat alle ondertekenaars het formulier hebben ondertekend. Forms wordt weergegeven in de status In afwachting van ondertekening totdat het formulier door alle ondertekenaars is ondertekend.
...
* Maken [aangepaste foutpagina&#39;s weergegeven door fouthandler](https://helpx.adobe.com/experience-manager/6-2/sites-developing/customizing-errorhandler-pages.html).
