...
De klassen van de cliënt die worden vereist om Geweven Projecten te bouwen gebruikend AEM de Diensten van het Document zijn beschikbaar in [AEM Forms Client SDK](https://helpx.adobe.com/aem-forms/kb/aem-forms-releases.html) jar. Voor informatie over beproefde projecten raadpleegt u [hoe u uw AEM project bouwt met Maven](/help/sites-developing/ht-projects-maven.md).
...
>[!NOTE]
>
>Al deze services gebruiken het object Document als een invoerparameter waarvoor de Javadoc kan worden gevonden op de URL [https://helpx.adobe.com/experience-manager/6-4/forms/javadocs/index.html](https://helpx.adobe.com/experience-manager/6-4/forms/javadocs/index.html)
