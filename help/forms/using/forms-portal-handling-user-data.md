...
* Voor verzendacties anders dan **Forms Portal Handeling** verzenden wordt de **[!UICONTROL Store data in forms portal]** optie ingeschakeld in de eigenschappen **Verzending** van de adaptieve formuliercontainer.
