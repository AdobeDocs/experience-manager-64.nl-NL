...
1. [Aangepaste formuliereigenschappen bewerken voor Adobe-ondertekening](/help/forms/using/working-with-adobe-sign.md#main-pars-header-46741052)
1. [Adobe-handtekeningvelden toevoegen aan een adaptief formulier](/help/forms/using/working-with-adobe-sign.md#main-pars-header-868561487)
1. [Adobe Sign inschakelen voor een adaptief formulier](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)
1. [Selecteer Adobe Sign Cloud Service voor een adaptief formulier](/help/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)

1. [Adobe-ondertekenaars toevoegen aan een adaptief formulier](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451)
1. [Selecteer Handeling verzenden voor een adaptief formulier](/help/forms/using/working-with-adobe-sign.md#main-pars-header)
...
1. Selecteer op het tabblad **[!UICONTROL Formuliermodel]** een van de volgende opties:
   ...
   * Selecteer de sjabloon Formulier [!UICONTROL koppelen als sjabloon]Document of Record** en selecteer een sjabloon Document of Record. Als u een op een formuliersjabloon gebaseerd adaptief formulier gebruikt, worden alleen de velden weergegeven die zijn gebaseerd op de bijbehorende formuliersjabloon. Niet alle velden van het adaptieve formulier worden weergegeven.
...
1. Selecteer op het tabblad **[!UICONTROL Standaard]** de [configuratiecontainer](/help/forms/using/adobe-sign-integration-adaptive-forms.md#configure-adobe-sign-with-aem-forms) die u hebt gemaakt tijdens de configuratie van Adobe Sign with AEM Forms.
1. Selecteer op het tabblad **[!UICONTROL Formuliermodus]**l een van de volgende opties:
...
1. Sleep de component **Adobe Sign Block** van de componentbrowser naar het aangepaste formulier. De Adobe-component Blok ondertekenen bevat alle ondersteunde Adobe-handtekeningvelden. Standaard wordt het veld **Handtekening **aan het aangepaste formulier toegevoegd.
...
1. Selecteer een cloudservice in de lijst met Adobe Sign Cloud Services die al is geconfigureerd.
   ...
   Als de lijst **Adobe Sign Cloud Service** leeg is, volgt u het artikel Adobe Sign with AEM Forms [](/help/forms/using/adobe-sign-integration-adaptive-forms.md) om de service te configureren.
...
1. [Voeg ondertekenaars toe aan een adaptief formulier](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451) en tik op het pictogram Done om de wijzigingen op te slaan.
...
Nadat u de adaptieve formuliereigenschappen voor Adobe-ondertekening [hebt](/help/forms/using/working-with-adobe-sign.md#main-pars-header-46741052)bewerkt, voert u de volgende stappen uit om het handtekeningveld voor de cloud toe te voegen aan een adaptief formulier:
...
1. Tik op het pictogram **Adobe Sign Field** ![name_6_3_adobesign](assets/aem_6_3_adobesign.png) . Er worden opties weergegeven voor het selecteren en toevoegen van Adobe-handtekeningvelden.
   ...
   * [Adobe Sign inschakelen voor een adaptief formulier](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)
   * [Selecteer Adobe Sign Cloud Service voor een adaptief formulier](/help/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)
   * [Adobe-ondertekenaars toevoegen aan een adaptief formulier](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451)
   * [Selecteer Handeling verzenden voor een adaptief formulier](/help/forms/using/working-with-adobe-sign.md#main-pars-header)
...
1. [Voeg en vorm de component](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)van de Stap van de Handtekening toe.
1. [Voeg de component](/help/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)Samenvattingsstap toe.
