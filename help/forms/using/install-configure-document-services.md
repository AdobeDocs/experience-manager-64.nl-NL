...
1. Navigeer naar **[!UICONTROL Lokaal computerbeleid > Computerconfiguratie > Windows-instellingen > Beveiligingsinstellingen > Lokaal beleid > Toewijzing]** gebruikersrechten en bewerk het tokenbeleid **[!UICONTROL Op procesniveau vervangen]** en neem de groep Beheerders op.
...
1. Meld u aan bij de AEM-auteur en navigeer naar **[!UICONTROL Adobe Experience Manager > Gereedschappen > Formulieren > PDF-generator]** configureren. De standaard-URL is http://localhost:4502/libs/fd/pdfg/config/ui.html.
