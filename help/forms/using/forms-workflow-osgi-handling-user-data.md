...
1. Ga naar de CRXDE Lite-console, navigeer naar het payload-pad voor een werkstroominstantie en verwijder het `payload` knooppunt.
...
1. Offline concept- en verzendgegevens van deelnemers aan de AEM Forms-app opsporen en verwijderen om verzending naar de server te voorkomen.
