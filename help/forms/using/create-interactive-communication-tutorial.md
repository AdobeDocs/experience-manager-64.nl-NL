...
**Afdruksjabloon:** [maken_eerste_ic_print_sjabloon](/help/forms/using/create-templates-print-web.md)
...
**Lay-outfragmenten:** [tabel_lf](/help/forms/using/create-templates-print-web.md)
...
1. Tik **Bewerken** om de interactieve communicatie in het rechterdeelvenster te openen.
1. Voer stap 6 - 15 van [Interactieve communicatie voor het kanaal van de Druk ](#create-interactive-communication-for-print-channel) sectie uit.
