...
1. Tikken **Bewerken** om de Interactieve Communicatie in de juiste ruit te openen.
1. Voer stap 6 - 15 uit van [Interactieve communicatie voor afdrukkanaal maken](#create-interactive-communication-for-print-channel) sectie.
...
1. Herhaal stap 13 - 18 van [Interactieve communicatie voor webkanaal maken](#create-interactive-communication-for-web-channel) om de **Nu betalen** en **Abonneren** hyperlinks in het kanaal van het Web van de Interactieve Mededeling.
