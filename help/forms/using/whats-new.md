...
Lees verder voor een snelle inleiding op nieuwe functies en verbeteringen. Raadpleeg de documentatie voor bronnen die informatie bieden. Zie ook AEM 6.4 Forms [releaseopmerkingen](/help/release-notes/forms.md). Voor volledige AEM 6.4 Forms-documentatie gaat u naar [AEM 6.4 Forms-gids](/help/forms/home.md).
...
Zie voor meer informatie [Interactieve communicatie - overzicht](/help/forms/using/interactive-communications-overview.md).
...
![slepen-n-drop-lf](assets/drag-n-drop-lf.png)

Zie voor meer informatie [Inleiding tot creatie Interactieve Communicatie](/help/forms/using/introduction-interactive-communication-authoring.md).
...
Zie voor meer informatie [Kanaal en webkanaal afdrukken](/help/forms/using/web-channel-print-channel.md).

### Thema&#39;s gebruiken om webkanalen voor interactieve communicatie op te maken {#use-themes-to-style-web-channel-of-interactive-communication}
...
Zie voor meer informatie [Thema&#39;s in AEM Forms](/help/forms/using/themes.md).
...
Zie voor meer informatie [Bereid en verzend Interactieve Communicatie gebruikend de Agent UI voor](/help/forms/using/prepare-send-interactive-communication.md).

### Informatie in grafieken presenteren {#present-information-in-charts}
...
Zie voor meer informatie [Het gebruiken van grafieken in Interactieve Mededelingen](/help/forms/using/chart-component-interactive-communications.md).

### Buiten-de-box gegevensschakelaars aan vooraf ingevulde documenten {#out-of-the-box-data-connectors-to-prefill-documents}
...
Zie voor meer informatie [Formuliergegevensmodel gebruiken](/help/forms/using/using-form-data-model.md).
...
Zie voor meer informatie [Formuliergegevensmodel maken](/help/forms/using/create-form-data-models.md).
...
Zie voor meer informatie [Werken met formuliergegevensmodel](/help/forms/using/work-with-form-data-model.md).
...
Een update in gegevensbronentiteiten of -eigenschappen wordt niet automatisch weerspiegeld in gekoppelde formuliergegevensmodellen. Editor van formuliergegevensmodel bevat nu functies ![refresh_forms_di](assets/refresh_forms_di.png) (Gegevensbrondefinities vernieuwen) waarmee de servercache wordt ongeldig gemaakt en het bijgewerkte schema van de gegevensbron wordt opgehaald om direct in het formuliergegevensmodel te worden weergegeven.

### Gegevensbronnen configureren met de Touch-gebruikersinterface {#configure-data-sources-using-touch-user-interface}

Met deze release is de configuratie van de cloudservices voor gegevensbronnen beschikbaar in de Touch-gebruikersinterface. De locatie voor het configureren van cloudservices is ook gewijzigd in **[!UICONTROL Tools > Cloud Services > Data Sources]**. Zie [Gegevensbronnen configureren](/help/forms/using/configure-data-sources.md).
...
### De prestaties van adaptieve formulieren verbeteren met verbeterd en lui laden {#improve-performance-of-adaptive-forms-with-enhanced-lazy-loading}
...
Met Forms-Centric AEM Workflows kunt u snel workflows voor verschillende taken op de OSGi-stapel maken en implementeren. U hoeft niet langer de op de JEE-stack beschikbare mogelijkheid voor Process Management te installeren, de implementatie te vereenvoudigen en de kosten van toepassingsservers en -infrastructuren te elimineren. Zie voor meer informatie [Forms-gecentreerde workflows op OSGi](/help/forms/using/aem-forms-workflow.md).
...
Met de AEM Forms-app kunnen veldwerkers hun mobiele apparaten synchroniseren met een AEM Forms-server en aan hun formulieren werken. De toepassing werkt naadloos wanneer het apparaat offline is door gegevens lokaal op het apparaat op te slaan en de gegevens met de server te synchroniseren wanneer het apparaat weer online is. Zie voor meer informatie [AEM Forms-app](/help/forms/using/aem-forms-app.md).
...
* Documentbeveiliging C++ SDK en C++ PPL-bibliotheek kunnen worden gecompileerd met Microsoft Visual Studio 2013. De eerder ondersteunde versie was Microsoft Visual Studio 2010.
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li>Connector voor IBM Filenet 5.0</li> 
