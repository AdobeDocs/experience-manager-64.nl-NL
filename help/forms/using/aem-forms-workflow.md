...
1. Ga in de AEM auteur naar ![Gereedschappen](assets/tools.png) > **[!UICONTROL Forms]** > **[!UICONTROL Manage Workflow Application]** en tikken **[!UICONTROL Create]**.
...
1. Ga naar de ![gereedschappen](assets/tools.png) voor de AEM auteur **[!UICONTROL Forms > Configure Watched Folder]**. Er wordt een lijst met al geconfigureerde gecontroleerde mappen weergegeven.
