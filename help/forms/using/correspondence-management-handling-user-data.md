...
>[!NOTE]
>
>In AEM 6.4 Forms is het correspondentiebeheer niet beschikbaar in het vak. Als u een upgrade uitvoert van een eerdere versie van AEM Forms, installeert u het compatibiliteitspakket en migreert u de middelen voor het beheer van correspondentie om deze te blijven gebruiken in AEM 6.4 Forms. Zie [Compatibiliteitspakket](/help/forms/using/compatibility-package.md)voor meer informatie.
