...
1. Configuratie zoeken en tikken **[!UICONTROL Day CQ Link Externalizer]** .
...
1. Ga naar Configuratie OSGi in https://&lt;*hostname>*:&lt;*port>*/system/console/configMgr.
1. Zoek en tik **[!UICONTROL Day CQ Mail Service]** om het te openen voor configuratie.
...
1. (Alleen **** instantie Auteur) Ga naar **[!UICONTROL Tools]** > **[!UICONTROL Cloud Services]** > **[!UICONTROL Data Sources]** > **[!UICONTROL global]**. Selecteer **[!UICONTROL roi-rest]** en tik op **[!UICONTROL Properties]**. Tik **[!UICONTROL Authentication Settings]** en stel **[!UICONTROL Authentication Type]** in op **[!UICONTROL Basic Authentication]**. Geef `admin`/ op `admin`als gebruikersnaam/wachtwoord voor toegang tot de service. Tik op **[!UICONTROL Save & Close]**.
