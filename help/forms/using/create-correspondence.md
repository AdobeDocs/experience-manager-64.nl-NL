...
1. Voer de vereiste gegevens- en inhoudsvariabelen in de velden in. Vul alle verplichte velden die zijn gemarkeerd met een sterretje (&amp;ast;) in om de knop **Verzenden** in te schakelen.
...
1. Bewerk desgewenst de inhoudsmodules op het tabblad Inhoud. Als u de relevante inhoudsmodule in de inhoudshiërarchie de focus wilt geven, kunt u op de desbetreffende regel of alinea in de lettervoorvertoning tikken of rechtstreeks in de inhoudshiërarchie op de inhoudsmodule tikken.
   ...
   Voor meer informatie over de acties beschikbaar voor diverse modules in Create Correspondence gebruikersinterface, zie [Acties en informatie beschikbaar in Create Correspondence gebruikersinterface](create-letter.md).
...
1. Tik op Opslaan als concept om de brief als concept op te slaan. U kunt deze later blijven bewerken. Als u deze optie wilt gebruiken, moet uw brief [gepubliceerd](/help/forms/using/publishing-unpublishing-forms.md#publishanasset) zijn. Voor meer informatie, zie de Instantie van het Ontwerp onder [Het bewaren van concepten en het voorleggen van brieveninstanties](#savingdrafts).
...
1. Als de afgevlakte PDF-voorvertoning naar wens is, tikt u op **Verzenden** om de letter te verzenden. Als u de letter wilt wijzigen, tikt u op **Voorvertoning afsluiten** om terug te keren naar de voorvertoning van de letter &#39;Correspondentie maken&#39; om wijzigingen in de letter aan te brengen. Wanneer u op Verzenden tikt en de configuratie Letterinstantie beheren is ingeschakeld in de instantie Publiceren, wordt de instantie Verzendbrief gegenereerd.
   ...
   Zie [Verschillen tussen HTML5-formulieren en PDF forms voor informatie over verschillen tussen HTML5-formulieren en PDF forms](/help/forms/using/feature-differentiation-html5-forms-pdf-forms.md).
