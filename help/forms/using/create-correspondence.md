...
1. Voer de vereiste gegevens- en inhoudsvariabelen in de velden in. Vul alle verplichte velden in die zijn gemarkeerd met een sterretje (&amp;ast;) om de knop **Verzenden** in te schakelen.
...
1. Tik op Opslaan als concept om de brief als concept op te slaan. U kunt deze later blijven bewerken. Als u deze optie wilt gebruiken, moet uw brief worden [gepubliceerd](/help/forms/using/publishing-unpublishing-forms.md#publishanasset). Voor meer informatie, zie de Instantie van het Ontwerp onder het [Opslaan van concepten en het voorleggen van brievenexemplaren](#savingdrafts).
