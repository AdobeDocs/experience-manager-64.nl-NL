...
1. Klik om het tabblad **[!UICONTROL Form Model]** te openen en selecteer in het vervolgkeuzemenu **[!UICONTROL Select From]** een van de volgende modellen voor het fragment:
...
1. Klik **[!UICONTROL Create]** en klik dan **[!UICONTROL Open]** om het fragment, met een standaardmalplaatje, op Edit wijze te openen.
...
1. Geef in het dialoogvenster Fragment maken de volgende informatie op:
   ...
   * **[!UICONTROL Fragment Model Root]**: Wordt alleen weergegeven in op XSD gebaseerde adaptieve formulieren. Hiermee geeft u de basis voor het fragmentmodel op. U kunt **/** of het complexe type van XSD van drop-down kiezen. U kunt het fragment alleen opnieuw gebruiken in een ander adaptief formulier als u het complexe type selecteert als hoofdknooppunt van het fragmentmodel.
...
1. Klik **[!UICONTROL Assets]** ![assets-browser](assets/assets-browser.png) in de zijbalk. Selecteer **[!UICONTROL Adaptive Form Fragments]** in het keuzemenu in de middelenbrowser.
...
U kunt een adaptief formulierfragment vervangen of wijzigen door een ander fragment met de eigenschap **[!UICONTROL Select Fragment asset]** in het dialoogvenster Component bewerken voor een adaptief deelvenster met formulierfragmenten.
...
1. Klik op **[!UICONTROL Select]** op de werkbalk van de gebruikersinterface van AEM Forms en selecteer een adaptief formulierfragment. Op de werkbalk worden de volgende bewerkingen weergegeven die u kunt uitvoeren op het geselecteerde adaptieve formulierfragment.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>Hiermee kunt u een revisie van het geselecteerde fragment starten en beheren. Zie <a href="/help/forms/using/create-reviews-forms.md" target="_blank">Revisies maken en beheren</a>.<br /> <br /> </p> </td> 
  </tr> 
  <tr> 
...
Aangepaste formulierfragmenten voor verwijzingen die u kunt gebruiken om uw formulier te maken, zijn beschikbaar. Zie [Referentiefragmenten](/help/forms/using/reference-adaptive-form-fragments.md) voor meer informatie.
