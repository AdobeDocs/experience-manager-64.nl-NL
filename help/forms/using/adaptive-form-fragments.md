...
1. Klik om het dialoogvenster **[!UICONTROL Form Model]** en van de **[!UICONTROL Select From]** selecteert u een van de volgende modellen voor het fragment:
...
1. Klikken **[!UICONTROL Create]** en klik vervolgens op **[!UICONTROL Open]** om het fragment met een standaardsjabloon te openen in de bewerkingsmodus.

In de bewerkingsmodus kunt u elke adaptieve formuliercomponent van het AEM hulpstuk naar het fragment slepen en neerzetten. Voor informatie over adaptieve formuliercomponenten raadpleegt u [Inleiding tot het ontwerpen van adaptieve formulieren](/help/forms/using/introduction-forms-authoring.md).
...
1. Geef in het dialoogvenster Fragment maken de volgende informatie op:
   ...
   * **[!UICONTROL Form Model]**: Afhankelijk van het formuliermodel voor het aangepaste formulier wordt in dit veld het volgende weergegeven: **[!UICONTROL XML Schema]**, **[!UICONTROL Form Template]**, of **[!UICONTROL None]**. Het is een niet-bewerkbaar veld.
   * **[!UICONTROL Fragment Model Root]**: Wordt alleen weergegeven in op XSD gebaseerde adaptieve formulieren. Hiermee geeft u de basis voor het fragmentmodel op. U kunt **/** of het XSD-complexe type uit de vervolgkeuzelijst. U kunt het fragment alleen opnieuw gebruiken in een ander adaptief formulier als u het complexe type selecteert als hoofdknooppunt van het fragmentmodel.
...
1. Klikken **[!UICONTROL Assets]** ![assets-browser](assets/assets-browser.png) in de zijbalk. Selecteer in de middelenbrowser de optie **[!UICONTROL Adaptive Form Fragments]** in de vervolgkeuzelijst.
...
U kunt een adaptief formulierfragment insluiten in een adaptief formulier door op **[!UICONTROL Embed Asset: *fragmentName *]**op de paneelwerkbalk van het toegevoegde fragment, zoals in de volgende voorbeeldafbeelding wordt getoond.
...
U kunt een adaptief formulierfragment vervangen of wijzigen door een ander fragment met de opdracht **[!UICONTROL Select Fragment asset]** in het dialoogvenster Component bewerken voor een adaptief deelvenster voor formulierfragmenten.
...
1. Klikken **[!UICONTROL Select]** in de gebruikersinterface van AEM Forms en selecteer een adaptief formulierfragment. Op de werkbalk worden de volgende bewerkingen weergegeven die u kunt uitvoeren op het geselecteerde adaptieve formulierfragment.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>Hiermee kunt u een revisie van het geselecteerde fragment starten en beheren. Zie voor meer informatie <a href="/help/forms/using/create-reviews-forms.md" target="_blank">Revisies maken en beheren</a>.<br /> <br /> </p> </td> 
  </tr> 
  <tr> 
...
* (**Alleen Mac**) Om ervoor te zorgen dat de functionaliteit van formulierfragmenten perfect werkt in alle scenario&#39;s, voegt u de volgende vermelding toe aan het bestand /private/etc/hosts:
   ...
   **Hostmachine**: De Apple Mac-computer waarop AEM Forms wordt geïmplementeerd.

## Referentiefragmenten {#reference-fragments}

Aangepaste formulierfragmenten voor verwijzingen die u kunt gebruiken om uw formulier te maken, zijn beschikbaar. Zie voor meer informatie [Referentiefragmenten](/help/forms/using/reference-adaptive-form-fragments.md).
