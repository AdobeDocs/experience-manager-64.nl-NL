...
* Voor adaptieve formulieren met behulp van de [XFA-formuliersjabloon](/help/forms/using/prepopulate-adaptive-form-fields.md), gebruik vooraf ingevulde XML volgend met het gegevensschema van het malplaatje XFA.
...
* Voor adaptieve formulieren met [JSON-schema](/help/forms/using/prepopulate-adaptive-form-fields.md#json-schema-based-adaptive-forms), gebruikt u de Prefill JSON die compatibel is met het JSON-schema.
* Gebruik voor adaptieve formulieren met FDM-schema de Prefill JSON die compatibel is met het FDM-schema.
* Voor adaptieve formulieren met [geen formuliermodel](/help/forms/using/prepopulate-adaptive-form-fields.md#p-adaptive-form-with-no-form-model-p)Er zijn geen gebonden gegevens. Elk veld is een niet-gebonden veld en wordt voorgevuld met de niet-gebonden XML.
...
Voor adaptieve formulieren op basis van JSON-schema wordt de structuur van de prefill JSON en de ingediende JSON hieronder beschreven. Zie voor meer informatie [Aangepaste formulieren maken met JSON-schema](/help/forms/using/adaptive-form-json-schema-form-model.md).
...
1. Voer de gegevenslocatie of een regex (reguliere expressie) voor de **[!UICONTROL Data files locations]**. Voorbeelden van geldige locaties voor gegevensbestanden zijn:

   * file:///C:/Users/public/Document/Prefill/.&amp;asteren;
...
* SERVICE_NAME verwijst naar de naam van de prefill dienst OSGI. Vernieuwen [Een vooraf ingevulde service maken en uitvoeren](/help/forms/using/prepopulate-adaptive-form-fields.md#create-and-run-a-prefill-service).
