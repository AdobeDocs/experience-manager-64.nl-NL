...
1. Voer de gegevenslocatie of een regex (reguliere expressie) voor de **[!UICONTROL Data files locations]** gegevens in. Voorbeelden van geldige locaties voor gegevensbestanden zijn:
