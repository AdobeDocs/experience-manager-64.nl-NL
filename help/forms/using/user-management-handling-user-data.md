...
Gebruikersbeheergegevens voor gebruikers die minstens één keer toegang hebben gekregen tot de Forms-toepassingen onder `https://[*server*]:[*host*]/lc` worden ook in AEM opslagplaats opgeslagen.
