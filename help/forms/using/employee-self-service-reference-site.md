...
![](assets/we-finance-home.png) wij-financier-home **** Cijfer: Portaal voor *organisaties*

![](assets/employee-dashboard.png) employee-dashboard **** Afbeelding: Dashboard voor *werknemers*
...
![](assets/conflict-inbox.png) conflict-inbox **** Figuur: Inbox *Gloria*

![](assets/conflict-approved.png) door conflict goedgekeurde **** afbeelding: Taak *openen*
...
![](assets/we-finance-home-1.png) we-finance-home-1 **** Figure: Portaal voor *organisaties*

![](assets/employee-dashboard-1.png) employee-dashboard-1 **** Afbeelding: Dashboard voor *werknemers*
...
![](assets/corporate-card-inbox.png) corporate-card-inbox **** Figure: Inbox *Gloria*

![](assets/corporate-card-approved.png) door de onderneming goedgekeurde **** figuur: Taak *openen*
...
![](assets/we-finance-home-2.png) wij-finance-home-2 **** Cijfer: Portaal voor *organisaties*

![](assets/employee-dashboard-2.png) employee-dashboard-2 **** Figure: Dashboard voor *werknemers*
...
![](assets/expense-report-inbox.png) uitgave-rapport-inbox **** Cijfer: Inbox *Gloria*

![](assets/expense-report-approved.png) goedgekeurde **** figuur van het uitgavenrapport: Taak *openen*
...
![](assets/we-finance-home-3.png) we-finance-home-3 **** Figure: Portaal voor *organisaties*

![](assets/employee-dashboard-3.png) employee-dashboard-3 **** Figure: Dashboard voor *werknemers*
...
![](assets/leave-inbox.png) leave-inbox **** Afbeelding: Inbox *Gloria*

![](assets/leave-approved.png) goedgekeurd **** figuur: Taak *openen*
