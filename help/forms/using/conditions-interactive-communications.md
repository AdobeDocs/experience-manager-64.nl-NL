...
1. Tik op de juiste middelen om deze te selecteren en vervolgens op de voorwaarde te tikken **[!UICONTROL Done]**.
...
1. Tik **[!UICONTROL Create Rule]** om regels toe te voegen om de elementen weer te geven of te verbergen. Zie Variabelen [](#variables)maken als u variabelen in de regels wilt gebruiken. Zie [Regels toevoegen aan voorwaarde](#ruleeditor)voor meer informatie.
...
1. Wanneer u een regel maakt of bewerkt in een voorwaarde, kunt u op ![icon_resize](assets/icon_resize.png) (Resize wijzigen) tikken om het dialoogvenster Regel maken/regel bewerken uit te vouwen.
...
1. Tik op een geldige regel nadat u deze hebt omgezet **[!UICONTROL Done]**.
