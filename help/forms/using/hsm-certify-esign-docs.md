...
1. Klik **Adobe Experience Manager** op de globale navigatiebalk. Ga naar **Gereedschappen** > **Beveiliging** > **Gebruikers**.
...
1. Open **HSM Credentials Configuration Service** en geef waarden op voor de volgende velden:
   ...
   **Opmerking:** *tijdens het configureren van Etoken geeft u een numerieke waarde op voor het veld Id van HSM-sleuf. Er is een numerieke waarde vereist om de handtekeningbewerkingen te laten werken.*
