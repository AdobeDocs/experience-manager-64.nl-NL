...
AEM Forms is een krachtig platform op bedrijfsniveau. Interactieve communicatie is slechts een van de mogelijkheden van AEM Forms. Zie [Introductie tot AEM Forms](/help/forms/using/introduction-aem-forms.md)voor de volledige lijst met mogelijkheden.
