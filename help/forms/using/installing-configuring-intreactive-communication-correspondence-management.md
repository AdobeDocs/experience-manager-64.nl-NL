...
AEM Forms is een krachtig platform op bedrijfsniveau. Interactieve communicatie is slechts een van de mogelijkheden van AEM Forms. Voor de volledige lijst van mogelijkheden, zie [Inleiding aan Vormen](/help/forms/using/introduction-aem-forms.md)AEM.
...
AEM-formulieren worden geïntegreerd met Adobe Target, een Adobe Marketing Cloud-oplossing, om persoonlijke en boeiende ervaringen van klanten via meerdere digitale kanalen te bieden. Als u Adobe Target wilt gebruiken om interactieve communicatie aan te passen, [integreert u Adobe Target met AEM-formulieren](/help/forms/using/ab-testing-adaptive-forms.md#setupandintegratetargetinaemforms).
