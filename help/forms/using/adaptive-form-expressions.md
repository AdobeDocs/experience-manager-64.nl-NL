...
Wanneer de waarde van het veld **marital_status** verandert, wordt de expressie opnieuw geactiveerd. U kunt dropdown van de dienst van REST ook bevolken. Zie [Dropdowns dynamisch vullen voor gedetailleerde informatie](/help/forms/using/dynamically-populate-dropdowns.md).
