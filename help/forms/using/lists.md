...
1. Tik **Maken** > **Tekst.** Of selecteer een tekstelement en tik op  **Bewerken**.
...
1. Er wordt een teksteditor geopend en u voert de tekst in. Gebruik de werkbalk boven aan de pagina om de tekst, invoegvoorwaarden, koppeling en pagina-einden op te maken.
   ...
   * **Koppeling**: Hypertekstkoppeling invoegen in de tekst. Tik **[!UICONTROL Link]**, geef de koppeling op in het veld **[!UICONTROL URL]**, verwijder de standaardobjectnaam in het veld **[!UICONTROL Alt Text]** en tik op ![Opslaan](assets/save_icon.svg).
...
1. Tik op het tabblad **Tabel** en geef de volgende informatie op voor de indeling:
   ...
   * **Breedteverhouding:** verhouding van de tabelkolombreedten.
   ...
   Zie [Voorbeeld met voorbeeldbestanden voor een gedetailleerd voorbeeld van het gebruik van statische en dynamische tabellen in lay-outfragmenten: het gebruiken van statische en dynamische lijsten in een brief](create-letter.md#insert-data-modules-and-layout-fragments-in-a-letter-and-configure-them).
