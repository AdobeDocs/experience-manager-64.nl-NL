...
1. Als u een query wilt maken, klikt u op **Toevoegen** (+).
   ...
   **Een filter definiëren**
   ...
   1. Als u nog een filter aan de query wilt toevoegen, klikt u op **Toevoegen (+)** rechts van de filterrij.
      ...
      Als u een filter uit de query wilt verwijderen, klikt u op **Delete(-)** rechts van de filterrij.
...
1. Gebruik de opties in de rechterbovenhoek van het dialoogvenster **Rapport** om bewerkingen uit te voeren op het queryresultaat.
...
1. Een proces-/taakzoekopdracht uitvoeren. Zie voor meer informatie [Een zoekquery voor proces uitvoeren](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md#p-to-execute-a-search-query-p).
