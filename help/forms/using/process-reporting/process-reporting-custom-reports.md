...
1. Een aparte interface maken zoals wordt beschreven in [Een aparte UI maken](#creating-a-separate-ui-nbsp) sectie.
...
1. Het rapport UI is geïntegreerd aan het Proces Meldend UI. Nadat u de interface hebt geïntegreerd, ziet de bijgewerkte interface er ongeveer als volgt uit:
   ...
   ![Gebruikersinterface van nieuw toegevoegde aangepaste rapporten](assets/sample-ui-screen-shot-1.png)

   Gebruikersinterface van nieuw toegevoegde aangepaste rapporten

   ![Scherm Resultaten van de aangepaste rapporten](assets/jsp-display.png)
