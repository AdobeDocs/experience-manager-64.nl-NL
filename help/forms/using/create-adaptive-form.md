...
1. Tik **Maken** en selecteer **Adaptief formulier**. Er verschijnt een optie voor het selecteren van een sjabloon. Tik op de **Lege**-sjabloon om deze te selecteren en tik **Volgende**.

1. Er wordt een optie voor **Eigenschappen toevoegen** weergegeven. De velden **Title** en **Name** zijn verplicht:

   * **Titel:** Geef  `Add new or update shipping address` op in het veld Titel. In het titelveld wordt de weergavenaam van het formulier opgegeven. Met de titel kunt u het formulier identificeren in de AEM Forms-gebruikersinterface.
...
1. Tik ![in-/uitschakelen van zijpaneel](assets/toggle-side-panel.png) > ![treeexpandall](assets/treeexpandall.png). De componentbrowser wordt geopend. Sleep de component **Koptekst** van de componentbrowser naar het adaptieve formulier.
1. Tik **Logo**. De werkbalk wordt weergegeven. Tik ![aem_6_3_edit](assets/aem_6_3_edit.png) op de werkbalk, typ **We.Retail** en tik ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).

1. Tik op de afbeelding. De werkbalk wordt weergegeven. Tik ![cmp](assets/cmppr.png). De eigenschappenbrowser wordt links van het scherm geopend. **Blader** en upload de logoafbeelding. Tik ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png). De afbeelding wordt in de koptekst weergegeven.
...
1. Sleep de **Voettekst** component van ![treeexpandall](assets/treeexpandall.png) naar het adaptieve formulier. In dit stadium ziet het formulier er als volgt uit:
...
Componenten zijn bouwstenen van een adaptief formulier. AEM Forms biedt veel componenten om informatie in een adaptieve vorm vast te leggen en weer te geven. U kunt de componenten van ![treeexpandall](assets/treeexpandall.png) aan een vorm slepen. Zie [Inleiding tot het ontwerpen van adaptieve formulieren](/help/forms/using/introduction-forms-authoring.md) voor meer informatie over beschikbare componenten en de bijbehorende functionaliteit.

1. Sleep de component Numerieke box naar het aangepaste formulier. Plaats het voor de voettekstcomponent. Open eigenschappen van de component, wijzig **Titel** van de component in **`Customer ID`**, wijzig **Elementnaam** in **`customer_ID`**, schakel de optie **Vereist veld** in, schakel de optie **HTML5 Number Input Type** in en tik ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Sleep een component **Numeriek vak** voor de voettekstcomponent. Open eigenschappen van de component, stel waarden in die in de onderstaande tabel worden vermeld, en tik ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Sleep een **E-mail** component voor de voettekstcomponent. Open eigenschappen van de component, stel waarden in die in de onderstaande tabel worden vermeld en tik ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Sleep een **Bestandsbijlage** component voor de voettekstcomponent. Open eigenschappen van de component, stel waarden in die in de onderstaande tabel worden vermeld en tik ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Sleep een component **Submit Button** naar het aangepaste formulier. Plaats het voor de voettekstcomponent. Open eigenschappen van de component, wijzig de elementnaam in **address_adding_update_submit**, tik ![name_6_3_forms_save](assets/aem_6_3_forms_save.png). De indeling van het formulier is voltooid en het formulier ziet er als volgt uit:
...
1. Tik **Formuliercontainer** in de Inhoudsbrowser en tik ![cmp](assets/cmppr.png). De eigenschappenbrowser wordt aan de linkerkant geopend.
1. Ga naar **Verzending** > **Handeling verzenden**. Selecteer **E-mail verzenden**. Geef de volgende waarden op en tik ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
Aangepaste formulieren bieden ook een optie om een formulier voor verschillende apparaten te emuleren. Bijvoorbeeld iPhone, iPad en Desktop. U kunt zowel de **opties Voorvertoning** als **Emulator** ![liniaal](assets/ruler.png) in combinatie gebruiken om een formulier voor apparaten van verschillende schermgrootten voor te vertonen.

1. Tik op de optie **Voorvertoning** aan de rechterkant van de formuliereditor. Het formulier wordt geopend in de voorbeeldmodus. Als u de naam hebt gebruikt die in de zelfstudie wordt vermeld, is de voorbeeld-URL van het formulier [http://localhost:4502/content/dam/formsanddocuments/shipping-address-add-update-form/jcr:content?wcmmode=disabled](http://localhost:4502/content/dam/formsanddocuments/shipping-address-addition-updation-form/jcr:content?wcmmode=disabled)
1. Met ![liniaal](assets/ruler.png) kunt u zien hoe het formulier er op verschillende apparaten uitziet.
1. Vul de velden van het formulier in en tik **Verzenden**. Het formulier wordt verzonden en u wordt omgeleid naar de standaardpagina **Dankuwel**. U kunt ook een aangepaste pagina voor bedankt opgeven. Voor details, zie [Het vormen opnieuw richten pagina](/help/forms/using/configuring-redirect-page.md).
