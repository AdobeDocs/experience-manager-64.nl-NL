...
* Voeg pakket sun.util.agenda aan de lijst van gewenste personen van de Configuratie van de Firewall van de **Deserialization toe.** De configuratie wordt vermeld bij `https://[server]:[port]/system/console/configMgr`.
