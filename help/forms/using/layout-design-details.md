...
* Klik in Designer op **[!UICONTROL Bestand > Formuliereigenschappen > Standaard]** en controleer of de instelling PDF renderen/Indeling is ingesteld op Dynamisch XML-formulier.
