...
1. Zie [Voorbereiden om aan AEM Forms](https://www.adobe.com/go/learn_aemforms_prepareupgrade_63) te bevorderen om de taken te leren en uit te voeren die de verbetering met minimale serveronderbreking correct verzekeren.
...
1. Voordat u een upgrade uitvoert:
   ...
   1. Download AEM 6.4 Forms in het JEE-installatieprogramma van de [Adobe-licentiewebsite (LWS)](https://licensing.adobe.com/). U hebt een geldig onderhouds- en ondersteuningscontract nodig om het installatieprogramma te downloaden.
   1. Bepaal het type gegevensopslagruimte (CRX Repository) voor inhoud dat u wilt gebruiken. Slechts een paar AEM Forms over JEE-mogelijkheden gebruiken de persistentie van de opslagplaats voor inhoud en elementen. Installeer en configureer de opslagplaats voor inhoud alleen als u dergelijke AEM Forms op JEE-mogelijkheden wilt gebruiken:

      * In LiveCycle ES4 SP1 gebruiken de mogelijkheden Correspondentiebeheer, Forms Portal, HTML Workspace en Process Reporting de functie Inhoudsopslagplaats. Als u deze mogelijkheden niet hebt gebruikt in LiveCycle ES4 en u van plan bent deze mogelijkheden niet te gebruiken in AEM Forms, is de gegevensopslagruimte niet vereist.
      * In AEM Forms, Adaptive Forms, Correspondence Management, HTML5 Forms (ook wel mobiele formulieren genoemd in LiveCycle ES4 SP1), Forms Portal, HTML Workspace, Process Reporting, Forms centric workflows op OSGi, capabilities gebruik Content Repository. Als u van plan bent AEM Forms voor deze mogelijkheden te gebruiken, dan is de Bewaarplaats van de Inhoud vereist.
      * U hebt geen opslagplaats voor inhoud nodig voor documentbeveiliging voor AEM Forms.
      Bovendien zijn het type opslagplaats van LiveCycle en AEM Forms verschillend. Zie Een persistentietype [kiezen voor een AEM Forms-installatie](/help/forms/using/choosing-persistence-type-for-aem-forms.md)voor informatie over de beschikbare typen opslagruimten en verwante informatie.
   ...
   1. Zorg ervoor dat uw bestaande platform (dat wil zeggen toepassingsserver, database, besturingssysteem, Adobe Acrobat, toepassingen van derden en hardware) wordt ondersteund voor AEM 6.4 Forms op JEE. Raadpleeg het document [Ondersteunde combinaties van Platforms](/help/forms/using/aem-forms-jee-supported-platforms.md) voor informatie over ondersteunde hardware en software.
      ...
      >[!NOTE]
      >
      >Als u het persistentieformaat RDBMK gebruikt, gebruik één enkel gegevensbestand voor zowel bewaarplaats persistentie als documentdiensten die op AEM Forms op JEE lopen.
...
1. Voer de upgrade uit:
   ...
   1. Nadat de installatie volledig is, stel de Manager **van de** Configuratie in werking om diverse modules van AEM Forms te vormen en aangewezen configuraties te plaatsen. Samen met het vormen van montages, staat het toe om de weg van Globale Opslag van Gegevens (GDS) en crx-bewaarplaats te specificeren.

      >[!NOTE]
      >
      >Selecteer de **[!UICONTROL Upgrade from Adobe Experience Manager Forms 6.2.0]** optie in het scherm Taakselectie bijwerken. Met deze **[!UICONTROL Upgrade from Adobe Experience Manager Forms 6.2.0]** optie kan de configuratiemanager een upgrade uitvoeren van LiveCycle ES4 SP1 naar AEM 6.4 Forms.

   1. (Niet vereist voor AEM Forms document security module) Inhoud importeren naar de Content Repository (CRX-Repository) naar de AEM 6.4 Forms-server.
...
1. Controleer of de upgrade van de server is geslaagd:
   ...
   Voer een paar routineverrichtingen op de bijgewerkte server van AEM Forms uit om ervoor te zorgen dat de server met succes wordt bevorderd. U kunt enkele gemigreerde formulieren invullen en verzenden of documenten beveiligen voor een geslaagde upgrade.
...
1. Voordat u een upgrade uitvoert:
   ...
   1. Bepaal het type gegevensopslagruimte (CRX Repository) voor inhoud dat u wilt gebruiken. Slechts een paar AEM Forms over JEE-mogelijkheden gebruiken de persistentie van de opslagplaats voor inhoud en elementen. Installeer en configureer de opslagplaats voor inhoud alleen als u dergelijke AEM Forms op JEE-mogelijkheden wilt gebruiken:
      ...
      * In AEM Forms gebruiken Adaptive Forms, Correspondence Management, HTML5 Forms Portal, HTML Workspace, Process Reporting en Forms centric workflows op OSGi-mogelijkheden de Content Repository. Als u van plan bent AEM Forms voor deze mogelijkheden te gebruiken, dan is de Bewaarplaats van de Inhoud vereist.
      * U hebt geen opslagplaats voor inhoud nodig voor documentbeveiliging voor AEM Forms.
      Bovendien zijn het type opslagplaats van LiveCycle en AEM Forms verschillend. Zie Een persistentietype [kiezen voor een AEM Forms-installatie](/help/forms/using/choosing-persistence-type-for-aem-forms.md)voor informatie over de beschikbare typen opslagruimten en verwante informatie.
   ...
   1. Zorg ervoor dat uw bestaande platform (dat wil zeggen toepassingsserver, database, besturingssysteem, Adobe Acrobat, toepassingen van derden en hardware) wordt ondersteund voor AEM 6.4 Forms op JEE. Raadpleeg het document [Ondersteunde combinaties van Platforms](/help/forms/using/aem-forms-jee-supported-platforms.md) voor informatie over ondersteunde hardware en software.
      ...
      >[!NOTE] Als u RDBMK persistence-indeling gebruikt, gebruikt u één database voor zowel gegevensopslagpersistentie als documentservices die op AEM Forms op JEE worden uitgevoerd.
...
1. Voer de upgrade uit:
   ...
   1. Nadat de installatie volledig is, stel de Manager **van de** Configuratie in werking om diverse modules van AEM Forms te vormen en aangewezen configuraties te plaatsen. Samen met het vormen van montages, staat het toe om de weg van Globale Opslag van Gegevens (GDS) en crx-bewaarplaats te specificeren.
      ...
      >[!NOTE] Selecteer de **[!UICONTROL Upgrade from Adobe Experience Manager Forms 6.2.0]** optie in het scherm Taakselectie bijwerken. Met deze **[!UICONTROL Upgrade from Adobe Experience Manager Forms 6.2.0]** optie kan de configuratiemanager een upgrade uitvoeren van LiveCycle ES3 naar AEM 6.4 Forms.

   1. (Niet vereist voor de beveiligingsmodule van het AEM Forms-document) Voer een upgrade uit en importeer de CRX-opslagruimte naar de AEM 6.4 Forms-server.
