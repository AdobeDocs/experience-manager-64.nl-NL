...
1. Zie [Voorbereiden op een upgrade naar AEM Forms](https://www.adobe.com/go/learn_aemforms_prepareupgrade_63) om de taken te leren en uit te voeren die ervoor zorgen dat de upgrade correct wordt uitgevoerd met minimale serverdowntime.
...
1. Voordat u een upgrade uitvoert:
   ...
   1. Bepaal het type gegevensopslagruimte (CRX Repository) voor inhoud dat u wilt gebruiken. Slechts enkele AEM Forms on JEE-mogelijkheden gebruiken de persistentie van de opslagplaats voor inhoud en middelen. Installeer en configureer de opslagplaats voor inhoud alleen als u dergelijke AEM Forms-mogelijkheden voor JEE wilt gebruiken:
      ...
      * In AEM Forms, Adaptive Forms, Correspondence Management, HTML5 Forms (bekend als Mobile Forms in LiveCycle ES4 SP1), Forms Portal, HTML Workspace, Process Reporting, Forms centrische workflows op OSGi, mogelijkheden gebruiken Content Repository. Als u AEM Forms voor deze mogelijkheden wilt gebruiken, is de gegevensopslagruimte vereist.
      * U hebt geen opslagplaats voor inhoud nodig voor AEM Forms-documentbeveiliging.

      Bovendien zijn het type opslagplaats van LiveCycle en AEM Forms verschillend. Zie Een persistentietype [kiezen voor een AEM Forms-installatie](/help/forms/using/choosing-persistence-type-for-aem-forms.md)voor beschikbare typen opslagplaatsen en gerelateerde informatie.
   ...
   1. Zorg ervoor dat uw bestaande platform (dat wil zeggen toepassingsserver, database, besturingssysteem, Adobe Acrobat, toepassingen van derden en hardware) wordt ondersteund voor AEM 6.4 Forms op JEE. Raadpleeg het document [Ondersteunde combinaties van Platforms](/help/forms/using/aem-forms-jee-supported-platforms.md) voor informatie over ondersteunde hardware en software.
      ...
      >[!NOTE]
      >
      >Als u RDBMK persistence-indeling gebruikt, gebruikt u één database voor zowel de persistentie in de opslagruimte als de documentservices die op AEM Forms op JEE worden uitgevoerd.
...
1. Voer de upgrade uit:
   ...
   1. Nadat de installatie is voltooid, voert u de **configuratiemanager** uit om verschillende AEM Forms-modules te configureren en de juiste configuraties in te stellen. Samen met het vormen van montages, staat het toe om de weg van Globale Opslag van Gegevens (GDS) en crx-bewaarplaats te specificeren.

      >[!NOTE]
      >
      >Selecteer de **[!UICONTROL Upgrade from Adobe Experience Manager Forms 6.2.0]** optie in het scherm Taakselectie bijwerken. De **[!UICONTROL Upgrade from Adobe Experience Manager Forms 6.2.0]** optie staat de configuratiemanager toe om van LiveCycle ES4 SP1 aan AEM 6.4 Forms te bevorderen.
...
1. Voordat u een upgrade uitvoert:
   ...
   1. Bepaal het type gegevensopslagruimte (CRX Repository) voor inhoud dat u wilt gebruiken. Slechts enkele AEM Forms on JEE-mogelijkheden gebruiken de persistentie van de opslagplaats voor inhoud en middelen. Installeer en configureer de opslagplaats voor inhoud alleen als u dergelijke AEM Forms-mogelijkheden voor JEE wilt gebruiken:
      ...
      * In AEM Forms gebruiken Adaptive Forms, Correspondence Management, HTML5 Forms, Forms Portal, HTML Workspace, Process Reporting en Forms centric workflows op OSGi-mogelijkheden de Content Repository. Als u AEM Forms voor deze mogelijkheden wilt gebruiken, is de gegevensopslagruimte vereist.
      * U hebt geen opslagplaats voor inhoud nodig voor AEM Forms-documentbeveiliging.
   ...
   1. Zorg ervoor dat uw bestaande platform (dat wil zeggen toepassingsserver, database, besturingssysteem, Adobe Acrobat, toepassingen van derden en hardware) wordt ondersteund voor AEM 6.4 Forms op JEE. Raadpleeg het document [Ondersteunde combinaties van Platforms](/help/forms/using/aem-forms-jee-supported-platforms.md) voor informatie over ondersteunde hardware en software.
      ...
      >[!NOTE] Als u RDBMK persistence-indeling gebruikt, gebruikt u één database voor zowel de persistentie van de opslagruimte als documentservices die op AEM Forms op JEE worden uitgevoerd.
...
1. Voer de upgrade uit:
   ...
   1. Nadat de installatie is voltooid, voert u de **configuratiemanager** uit om verschillende AEM Forms-modules te configureren en de juiste configuraties in te stellen. Samen met het vormen van montages, staat het toe om de weg van Globale Opslag van Gegevens (GDS) en crx-bewaarplaats te specificeren.
      ...
      >[!NOTE] Selecteer de **[!UICONTROL Upgrade from Adobe Experience Manager Forms 6.2.0]** optie in het scherm Taakselectie bijwerken. De **[!UICONTROL Upgrade from Adobe Experience Manager Forms 6.2.0]** optie staat de configuratiemanager toe om van LiveCycle ES3 aan AEM 6.4 Forms te bevorderen.
...
1. Controleer of de upgrade van de server is geslaagd:
   ...
   >[!NOTE] In AEM 6.4 Forms is de structuur van crx-repository veranderd. Nadat u een upgrade hebt uitgevoerd naar AEM 6.4-formulieren, gebruikt u de gewijzigde paden voor aanpassing die u opnieuw maakt. Voor de volledige lijst van gewijzigde paden, zie de Herstructurering van de Bewaarplaats van [Forms in AEM 6.4](/help/sites-deploying/forms-repository-restructuring-in-aem-6-4.md).
