...
1. Navigeren naar **[!UICONTROL Adobe Experience Manager > Tools > Templates]** en opent u de map waarin u de sjabloon hebt gemaakt.
...
Nadat u een sjabloon hebt gemaakt en ingeschakeld, is deze beschikbaar in formulierbeheer wanneer u een adaptief formulier maakt. Als u een sjabloon wilt gebruiken en een adaptief formulier wilt maken, raadpleegt u [Een adaptief formulier maken](/help/forms/using/creating-adaptive-form.md).
