...
Deze zelfstudie is een stap in de [serie Uw eerste adaptieve formulier](create-your-first-adaptive-form.md) maken. U wordt aangeraden de reeks in chronologische volgorde te volgen om het volledige gebruik van de zelfstudie te begrijpen, uit te voeren en aan te tonen.
...
1. Navigeer in het deelvenster Kiezers naar de optie **Koptekst** > **Tekst** . Het deelvenster Kiezers bevindt zich links van de themaeditor. Als het deelvenster niet zichtbaar is, tikt u op Zijpaneel ![in-/uitschakelen](assets/toggle-side-panel.png) .
