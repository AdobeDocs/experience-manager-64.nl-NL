...
1. Navigeren naar `/libs/fd/af/runtime/clientlibs/guideRuntime`en voeg de `fp.validation` aan de **insluiten** eigenschap.

1. Navigeer naar /libs/fd/af/runtime/clientlibs/guideRuntimeWithXFA en voeg de `fp.validation` waarde aan **insluiten** eigenschap.
