...
* Van uw lijst Aan, zonder de taak te openen
   ...
   Opmerking: Deze optie is beschikbaar als `isMustOpenToComplete` veld is niet geselecteerd in het dialoogvenster `Assign Task` stap in Workbench tijdens het ontwerpen van een proces.
