...
1. Selecteren **Bestand** > **Opslaan als** om het bestand op te slaan op het lokale bestandssysteem:
   ...
   Nadat u een XDP-sjabloon voor een lay-outfragment hebt gemaakt met de Forms Designer, moet u [uploaden](/help/forms/using/create-templates-print-web.md#upload-xdp-template-to-the-aem-forms-server) wordt naar de AEM Forms-server gestuurd, zodat de sjabloon beschikbaar is voor gebruik tijdens het maken van lay-outfragmenten.
...
1. Tikken **Gereedschappen** ![Gereedschappen](assets/tools-icon.svg) > **Configuratiebrowser**.
...
1. Tikken **Gereedschappen** ![Gereedschappen](assets/tools-icon.svg) > **Sjablonen**.
