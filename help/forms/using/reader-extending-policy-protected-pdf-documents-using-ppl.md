...
## Reader voor het uitbreiden van PDF-documenten die met beveiligingsbeleid zijn beveiligd {#reader-extending-document-security-policy-protected-pdf-documents}
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Geef InputStream op die het PDF-document vertegenwoordigt waaruit gebruiksrechten<br /> moeten worden verwijderd. U kunt documenten met een beveiliging tegen LiveCycle Rights Management of AEM Forms-documenten gebruiken.</td> 
  </tr> 
 </tbody> 
</table>
