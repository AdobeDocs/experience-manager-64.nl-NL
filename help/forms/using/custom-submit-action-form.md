...
>[!NOTE]
>
>Een auteur verstrekt Redirect URL (gebruikend de Dank u Configuratie van de Pagina). [OOTB verzendt Acties](/help/forms/using/configuring-submit-actions.md) gebruikt Redirect URL om browser van het middel om te leiden dat de voorwaartse weg verwijzingen.
>
