...
U kunt de SDK van de Veiligheid van het Document, Adobe Acrobat, de Uitbreiding van de Veiligheid van het Document voor Microsoft Office, of de Bibliotheek van de Portable Bescherming gebruiken om het veiligheidsbeleid toe te passen en te volgen:
...
* **Adobe Acrobat:** Met Adobe Acrobat kunt u beveiligingsbeleid toepassen op PDF-documenten die zijn gemaakt met populaire bureaubladtoepassingen, zoals Microsoft Office, webbrowsers of elke toepassing die afdrukken in PDF-indeling ondersteunt.
   ...
   U kunt Adobe Acrobat aanschaffen en downloaden van [Adobe Website](https://acrobat.adobe.com/us/en/free-trial-download.html). Het Adobe Acrobat-artikel waarin beveiligingsbeleid voor PDF&#39;s [wordt](https://helpx.adobe.com/acrobat/using/setting-security-policies-pdfs.html) ingesteld, bevat gedetailleerde informatie over het maken en toepassen van beleid in Adobe Acrobat.
...
* **Index iFilter:** U kunt de iFilter-index gebruiken om beveiligde PDF-documenten te indexeren en Microsoft Windows-zoekprogramma&#39;s met volledige tekst (Desktop Indexing Service en SharePoint Indexserver) inschakelen om beveiligde PDF-documenten te doorzoeken. Voor gedetailleerde informatie zie, [AEM SharePoint IFilter voor Beschermde Documenten](assets/sharepoint-ifilter-doc-security.pdf).
