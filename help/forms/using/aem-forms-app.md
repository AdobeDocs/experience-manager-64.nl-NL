...
Voor de app AEM Forms is een AEM Forms-server vereist. Gebruikers kunnen formulieren weergeven die u maakt in AEM Forms\
...
Zie [Conard krijgt evaluatietaak](/help/forms/using/gov-reference-site-walkthrough.md#contard-assessment-task) in de documentatie bij de website voor meer informatie over de AEM Forms-app die werkt met AEM Forms Server.
