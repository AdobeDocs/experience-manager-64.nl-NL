...
1. Ga als volgt te werk om een voorwaarde te maken voor het evalueren of de geselecteerde/geconditioneerde tekst in de letter staat en tik vervolgens op het vinkje om de expressie op te slaan:
   ...
   Voor meer informatie bij het creëren van de uitdrukking, zie het **Creëren van uitdrukkingen en verre functies met uitdrukkingsbouwer** in de Bouwer [van de](/help/forms/using/expression-builder.md)Uitdrukking. De waarde die in de expressie wordt opgegeven, moet worden ondersteund voor het element in het gegevenswoordenboek. Zie [Gegevenswoordenboek](/help/forms/using/data-dictionary.md)voor meer informatie.
