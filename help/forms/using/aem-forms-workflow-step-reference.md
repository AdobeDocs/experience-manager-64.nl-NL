...
* **Te vullen informatie:** De volgende velden die hieronder worden vermeld, dienen als invoer voor de taak:
   ...
   * **Pad bijlage:** Bijlagen die beschikbaar zijn op de locatie, worden gekoppeld aan het formulier dat aan de taak is gekoppeld. Het pad is altijd relatief ten opzichte van de lading. Een voorbeeldpad is [Payload_Directory]/attachments/
