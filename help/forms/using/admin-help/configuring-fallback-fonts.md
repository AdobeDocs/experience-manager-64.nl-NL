...
1. Navigeer naar het bestand adobe-livecycle-*[appserver]*.ear in de *[aem-forms root]*/configurationManager/export directory, maak een reservekopie en pak het origineel uit.
...
1. Wijzig desgewenst de locaties en namen van de lettertypen Algemeen en Fallback en sla het bestand op.
   ...
   De fontitems in het bestand FontManagerResources.properties zijn relatief ten opzichte van de map *[aaem-forms root]*/fonts. Als u lettertypen opgeeft die niet standaard AEM formulierlettertypen zijn, moet u deze lettertypen installeren in deze mapstructuur (binnen een bestaande map of in een nieuw gemaakte map).
