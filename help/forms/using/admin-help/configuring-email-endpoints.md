...
**Bestandspatroon:** de inkomende patronen voor bestandsbijlagen die de provider accepteert. Dit omvat bestanden met specifieke extensies (&amp;ast;.dat, &amp;ast;.xml), specifieke namen (gegevens) en samengestelde expressies in de naam en de extensie (.[dD][aA][Tt]). De standaardwaarde is &amp;ast;.&amp;ast;.
...
**Bestandspatroon:** geeft de inkomende patronen voor bestandsbijlagen op die de provider accepteert. Dit omvat bestanden met specifieke extensies (&amp;ast;.dat, &amp;ast;.xml), specifieke namen (gegevens) of samengestelde expressies in de naam en extensie (&amp;ast;..[dD][aA][Tt]).
