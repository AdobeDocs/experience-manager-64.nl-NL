...
+ AEM Forms installeren en configureren {#install-aem-forms}
   ...
   + AEM Forms installeren op JEE {#jee-installation}
      ...
      + [AEM Forms installeren en implementeren op JEE met JBoss-sleutel](http://www.adobe.com/go/learn_aemforms_installTurnkey_64)
      ...
      + [Installatie van één AEM Forms-server voorbereiden](http://www.adobe.com/go/learn_aemforms_prepareInstallsingle_64)
      + [AEM Forms installeren en implementeren op JEE voor JBoss](http://www.adobe.com/go/learn_aemforms_installJBoss_64)
      ...
      + [Installatie van servercluster AEM Forms voorbereiden](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_64)
      ...
      + [AEM Forms configureren bij JEE in WebSphere-cluster](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_64)
...
+ Upgrade van AEM Forms {#upgrade-aem-forms}
   ...
   + AEM Forms upgraden naar JEE {#aem-forms-jee-upgrade}
      ...
      + [Een upgrade uitvoeren van een AEM Forms-release naar AEM 6.4 Forms in JEE voor JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      + [Upgrade van LiveCycle ES4 SP1 naar Adobe Experience Manager Forms on JEE voor JBoss](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-jboss-livecycle.pdf)
      + [Een upgrade uitvoeren van een release van AEM Forms naar AEM 6.4 Forms op JEE voor JBoss turnkey](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      ...
      + [Een upgrade uitvoeren van een AEM Forms-release naar AEM 6.4 Forms op JEE for WebLogic](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      ...
      + [Een upgrade uitvoeren van een release van AEM Forms naar AEM 6.4 Forms op JEE for WebSphere](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
...
+ Referentie ontwikkelaar {#developer-reference}
   ...
   + [AEM Forms Java API-naslaggids](https://helpx.adobe.com/experience-manager/6-4/forms/javadocs/index.html)
   + [AEM Forms over JEE Java API-naslaggids](https://helpx.adobe.com/experience-manager/6-4/forms/ProgramLC/javadoc/index.html)
