...
+ AEM-formulieren installeren en configureren {#install-aem-forms}
   ...
   + AEM-formulieren installeren op JEE {#jee-installation}
      ...
      + [AEM-formulieren installeren en implementeren in JEE met JBoss-sleutel](http://www.adobe.com/go/learn_aemforms_installTurnkey_64)
      + [Alleen documentbeveiligingsserver installeren en configureren](using/installing-and-configuring-the-document-security-server.md)
      + [Installatie van één server voor AEM Forms voorbereiden](http://www.adobe.com/go/learn_aemforms_prepareInstallsingle_64)
      + [AEM-formulieren installeren en implementeren in JEE voor JBoss](http://www.adobe.com/go/learn_aemforms_installJBoss_64)
      + [AEM Forms installeren en implementeren op JEE for WebLogic](http://www.adobe.com/go/learn_aemforms_installWebLogic_64)
      + [AEM Forms installeren en implementeren op JEE for WebSphere](http://www.adobe.com/go/learn_aemforms_installWebSphere_64)
      ...
      + [Installatie van AEM Forms Server-cluster voorbereiden](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_64)
      + [AEM-formulieren op JEE configureren in JBoss-cluster](http://www.adobe.com/go/learn_aemforms_clusterJBoss_64)
      + [AEM-formulieren configureren op JEE in WebLogic-cluster](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_64)
      + [AEM-formulieren configureren op JEE in WebSphere-cluster](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_64)
...
+ AEM-formulieren upgraden {#upgrade-aem-forms}
   ...
   + AEM-formulieren upgraden naar JEE {#aem-forms-jee-upgrade}
      + [Upgrade van AEM-formulieren voorbereiden](http://www.adobe.com/go/learn_aemforms_prepareupgrade_64)
      + [Controlelijst voor upgrades en planning](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64)
      + [Upgrade naar AEM 6.4-formulieren op JEE](using/upgrade-forms-jee.md)
      + [Een upgrade uitvoeren van een AEM Forms-versie naar AEM 6.4 Forms in JEE voor JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      + [Een upgrade uitvoeren van LiveCycle ES4 SP1 naar Adobe Experience Manager Forms op JEE voor JBoss](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-jboss-livecycle.pdf)
      + [Een upgrade uitvoeren van een AEM Forms-versie naar AEM 6.4 Forms op JEE voor JBoss turnkey](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      + [Upgrade van LiveCycle ES4 SP1 naar AEM Forms on JEE voor JBoss Turnkey](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
      + [Een upgrade uitvoeren van een AEM Forms-versie naar AEM 6.4 Forms op JEE for WebLogic](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      + [Upgraden van LiveCycle ES4 SP1 naar AEM Forms on JEE for WebLogic](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-weblogic-livecycle.pdf)
      + [Een upgrade uitvoeren van een AEM Forms-versie naar AEM 6.4 Forms op JEE for WebSphere](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
      + [Upgraden van LiveCycle ES4 SP1 naar AEM Forms on JEE for WebSphere](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
...
+ Forms Designer {#use-forms-designer}
   ...
   + [Snelle zelfstudies voor Designer](http://www.adobe.com/go/learn_aemforms_designer_quick_start_64)
   + [Designer-voorbeelden](http://www.adobe.com/go/learn_aemforms_designer_samples_64)
...
+ Referentie ontwikkelaar {#developer-reference}
   ...
   + [AEM-formulieren in Java API-naslaggids voor JEE](https://helpx.adobe.com/experience-manager/6-4/forms/ProgramLC/javadoc/index.html)
   ...
   + Programmeren met AEM-formulieren op JEE {#programming-aem-forms-jee}
      ...
      + AEM-formulieren aanroepen op JEE met behulp van API&#39;s {#invoking-aem-forms-jee-apis}
         ...
         + [Flash Builder-toepassingen maken die SSO-verificatie uitvoeren met HTTP-tokens](developing/creating-flash-builder-applications-perform.md)
