...
In dit DDX-document worden twee PDF-documenten met de naam *map.pdf* en* richtingen.pdf* samengevoegd in één PDF-document. Het resulterende PDF-document bevat een koptekst die bestaat uit een unieke pagina-id. Het document in de bovenstaande afbeelding toont bijvoorbeeld 000016.
