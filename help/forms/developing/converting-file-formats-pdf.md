...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>Geeft aan hoe moet worden gereageerd op toepassingsspecifieke dialoogvensters. </p><p>Het bestand dat deze informatie bevat, is appmon.<i>[toepassingsnaam]</i>.dialog.<i>[landinstelling]</i>.xml (bijvoorbeeld appmon.word.en_US.xml).</p></td> 
...
>[!NOTE]
>
>In dit verband betekent de term &quot;aanvullend&quot; de inhoud van de appmon.[toepassingsnaam].optellen.[landinstelling].xml-bestand. Met een dergelijk bestand worden overschrijvingen en toevoegingen aan het XML-bestand van het dialoogvenster opgegeven.
...
1. In het dialoogvenster Nieuwe systeemvariabele in het dialoogvenster **Naam variabele** vak, typt u een naam die de indeling gebruikt *[toepassingsnaam]*_PAD.
