...
Wanneer u een beveiligd document doorgeeft, gebruikt u een eenmalige aanmelding en geeft u een gebruiker voor AEM-formulieren op die de *rol Gebruiker *van toepassing voor uploaden van document heeft. Zonder deze rol kan de gebruiker geen beveiligd document uploaden. U kunt een rol programmatically toewijzen aan een gebruiker. (Zie Rollen en machtigingen [beheren](/help/forms/developing/users.md#managing-roles-and-permissions).)
...
Als AEM Forms wordt gevormd om veilige documenten slechts toe te staan om worden geupload en de gebruiker niet het* Document heeft - de Gebruiker *rol van de Toepassing van de Toepassing uploaden, dan wordt een uitzondering geworpen. Als de gebruiker deze rol wel heeft, wordt het bestand geüpload en wordt het proces aangeroepen.
