...
Voor andere bronnen worden verschillende acties weergegeven. Sommige zijn:
- Kanalen: `boardcast-command`, `broadcast-command-with-ack`, `unassign`
- Displays: `boardcast-command`, `broadcast-command-with-ack`
- Apparaten: `boardcast-command`, `broadcast-command-with-ack`