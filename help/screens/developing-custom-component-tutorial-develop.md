...
1. [AEM 6.4](https://helpx.adobe.com/experience-manager/6-4/release-notes.html) of [AEM 6.3](https://helpx.adobe.com/experience-manager/6-3/release-notes.html) + Latest Screen Feature Pack
...
De lesstappen en schermafbeeldingen worden uitgevoerd met [CRXDE-Lite](http://localhost:4502/crx/de/index.jsp). [Eclipse](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/aem-eclipse.html) of [IntelliJ](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/ht-intellij.html) IDEs kan ook worden gebruikt om het leerprogramma te voltooien. Hier vindt u meer informatie over het gebruik van een IDE voor de ontwikkeling [met AEM.](https://helpx.adobe.com/experience-manager/kt/sites/using/getting-started-wknd-tutorial-develop/part1.html#eclipse-ide)

>[!NOTE]
>
>Voordat u met deze zelfstudie begint, is het raadzaam het volgende te controleren:
>
>1. [AEM-schermen begrijpen](https://helpx.adobe.com/experience-manager/kt/screens/using/screens-concepts-feature-video-understand.html)
>1. [Schermkaarthandleiding](https://helpx.adobe.com/experience-manager/6-4/sites/deploying/using/kickstart-for-aem-screens.html)
>
...
1. Navigeer in [CRXDE-Lite](http://localhost:4502/crx/de/index.jsp) (of winde van keus) naar `/apps/weretail-run/components/content/helloworld.`
...
1. Voeg de volgende eigenschappen toe aan de gedeelde clientbibliotheek:
   ...
   * `categories`| String[] | `cq.screens.components`
   ...
   Het is aan te raden geen paden in een productieomgeving rechtstreeks toegankelijk te maken voor /apps. De eigenschap allowProxy zorgt ervoor dat naar de CSS- en JS-clientbibliotheek wordt verwezen via het voorvoegsel of/etc.clientlibs. Meer informatie over de eigenschap [allowProxy vindt u hier.](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/clientlibs.html#main-pars_title_8ced)
...
1. Sjabloonstap - kies** Sequentiekanaal**
...
1. Navigeer in [CRXDE-Lite](http://localhost:4502/crx/de/index.jsp#/apps/settings/wcm/designs/we-retail-run/jcr%3Acontent/sequencechannel/par) naar `/apps/settings/wcm/designs/we-retail-run/jcr:content/sequencechannel/par`. Merk op dat de `components` eigenschap nu bevat `group:Screens`, `group:We.Retail Run - Content`.
