...
1. U kunt de segmentdefinitie **Bewerken** om deze een **Title**, **Description** en **[Boost](/help/sites-administering/campaign-segmentation.md#boost-factor)** factor te geven:
...
1. Druk op **[Ctrl-Alt-C](/help/sites-authoring/keyboard-shortcuts.md)** om de **[Clientcontext](/help/sites-administering/client-context.md)** te openen, waarin de verzamelde gegevens worden weergegeven. Voor testdoeleinden kunt u **Bewerken** bepaalde waarden, of **Laden** een ander profiel om de impact daar te zien.
