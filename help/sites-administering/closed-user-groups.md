...
>[!NOTE]
>
>Let op het verschil tussen `getEffectivePolicies` en het volgende codevoorbeeld dat de hiërarchie omhoog loopt om te kijken of een bepaald pad al deel uitmaakt van een bestaande CUG.
...
>[!NOTE]
>
>De wijzigingen aan een opgegeven hierboven vermelde doelnode worden alleen weerspiegeld in de Apache Sling Authenticator als het doel `RequirementHandler` is verward en het doel is opgenomen in de bomen die door de ondersteunde paden worden gedefinieerd (zie sectie Configuration Options).
>
...
Stappen om een nieuw authentificatievereiste met inbegrip van een login weg tot stand te brengen. Merk op, dat het vereiste en de uitsluiting voor de login weg slechts met Apache Sling Authenticator zullen worden geregistreerd als het voor de boom `RequirementHandler` is veroorzaakt die de doelknoop bevat.
...
Stappen om een bestaand authentificatievereiste te verwijderen. De vereiste wordt alleen niet geregistreerd bij de Apache Sling Authenticator als de voorwaarde `RequirementHandler` is verward voor de boomstructuur die het doelknooppunt bevat.
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    ...
    </ul> <p>Zie ook de <a href="/help/sites-administering/closed-user-groups.md#configuration-options" target="_blank">configuratieopties</a> hieronder.</p> </td> 
  </tr> 
  <tr> 
