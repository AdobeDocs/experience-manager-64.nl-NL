...
>[!NOTE]
>
>De wijzigingen in een opgegeven doelknooppunt hierboven worden alleen weerspiegeld in de Apache Sling Authenticator als de `RequirementHandler` is verward en het doel is bevat in de bomen die door de gesteunde wegen worden bepaald (zie de Opties van de SectieConfiguratie).
>
...
Stappen om een bestaand authentificatievereiste te verwijderen. De vereiste wordt alleen niet geregistreerd bij de Apache Sling Authenticator als de `RequirementHandler` is veroorzaakt voor de boom die de doelknoop bevat.
...
1. Voer het hoofdpad in waarop u CUG&#39;s wilt controleren en druk op de knop **droge run uitvoeren** knop. Hiermee wordt gescand op CUG&#39;s die kunnen worden geconverteerd naar de geselecteerde locatie.
