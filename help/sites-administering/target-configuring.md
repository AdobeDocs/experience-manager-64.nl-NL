...
Navigeer naar de **Cloud Services** via **Gereedschappen** > **Implementatie** > **Cloud** om de cloudconfiguratie en het framework te zoeken. ([http://localhost:4502/libs/cq/core/content/tools/cloudservices.html](http://localhost:4502/libs/cq/core/content/tools/cloudservices.html))\
