...
Navigeer naar de **Cloud Servicen** via **Gereedschappen** > **Implementatie** > **Cloud** om de cloudconfiguratie en het framework te zoeken. ([http://localhost:4502/libs/cq/core/content/tools/cloudservices.html](http://localhost:4502/libs/cq/core/content/tools/cloudservices.html))\
...
1. Klik op **Verbinding maken met Target** om de verbinding met Target te initialiseren. Als de verbinding tot stand is gebracht, wordt het bericht** Verbinding gelukt** weergegeven. Klik op **OK** in het bericht en vervolgens op **OK** in het dialoogvenster.
