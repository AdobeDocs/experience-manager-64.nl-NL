...
* **Pagina-editor (Dynamic Media Classic [voorheen Scene7] zoeken)**:
   ...
   Deze configuratie definieert de beschikbare opties bij het zoeken naar Dynamic Media Classic-bronnen in de middelenbrowser (bij het bewerken van een pagina).
...
1. Navigeren naar **Gereedschappen**, **Bewerkingen**, **Zoeken in Forms**.
