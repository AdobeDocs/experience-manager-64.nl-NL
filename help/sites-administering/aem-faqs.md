...
U moet de JS bewerker standaardconfigs bezit van de Manager van de Bibliotheek van Adobe granite HTML in ***min:gcc*** veranderen. Als u het ontwerppakket wilt importeren, kunt u het beste vooraf geminiateerde bibliotheken van derden opnemen in onze clientbibliotheken.
...
Zie voor meer informatie over het maximumaantal activa dat kan worden gebruikt met AEM 6.4 de [gids](/help/assets/assets-sizing-guide.md)voor middelengrootte.
...
Raadpleeg Asset Insights [instellen met AEM Assets](https://helpx.adobe.com/experience-manager/kt/assets/using/asset-insights-tutorial-setup.html)voor Experience Manager die wordt geïmplementeerd via Adobe Activation (DTM).
