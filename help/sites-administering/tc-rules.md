...
>[!NOTE]
>
>Na een upgrade naar 6.4 wordt aangeraden het bestand van /etc. te verplaatsen. Zie [Herstructurering van de gemeenschappelijke opslagplaats in AEM 6.4](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules) voor meer informatie .
...
In de Editor kunt u in- of uitschakelen **I`s Deep`** in de **Filters** tab.
