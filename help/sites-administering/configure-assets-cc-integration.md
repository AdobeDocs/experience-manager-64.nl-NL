...
>[!NOTE]
>
>Deze functie is afgekeurd in AEM Assets. Vervangingen zoeken in [Aanbevolen werkwijzen voor AEM en Creative Cloud-integratie](/help/assets/aem-cc-integration-best-practices.md). Als u vragen hebt, [contact opnemen met Adobe Klantenondersteuning](https://www.adobe.com/account/sign-in.supportportal.html).
...
1. Klik op **[!UICONTROL Create]**. Een bericht meldt dat de toepassing is gemaakt.
   ...
   ![Melding van geslaagde aanmaak van de toepassing voor de integratie van AEM Assets met Adobe Creative Cloud](assets/chlimage_1-289.png)
...
1. In de **[!UICONTROL Create Configuration]** een titel en naam voor de nieuwe configuratie op en klik op **[!UICONTROL Create]**.
   ...
   ![Geef een nieuwe configuratie de naam om AEM Assets en Creative Cloud te integreren](assets/cloudservices_configure_mc.png)
...
1. Voeg een of meer gebruikers toe die u de mogelijkheid wilt bieden elementen te delen met Creative Cloud.
   ...
   >[!NOTE]
   >
   >Alleen de gebruikers die u toevoegt aan Experience Cloud, kunnen elementen van AEM Assets naar Creative Cloud delen.
