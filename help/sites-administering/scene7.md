...
1. Als u AEM-elementen automatisch wilt uploaden naar Dynamic Media Classic, moet u die optie inschakelen en Dynamic Media Classic toevoegen aan de DAM-workflow voor update-elementen. U kunt ook handmatig elementen uploaden.
...
1. Voer het e-mailadres, het wachtwoord en de regio van uw Classic-account voor Dynamic Media in en tik op **[!UICONTROL Connect to Dynamic Media Classic]**. U bent verbonden met de Klassieke server van Dynamic Media en het dialoogvenster wordt uitgebreid met meer opties.
...
1. Klik op **[!UICONTROL OK]**. AEM slaat uw configuratie op.
...
1. Tik op het [!UICONTROL Tools] pictogram en navigeer naar **[!UICONTROL Operations > Web Console]**. De webconsole wordt geopend.
...
1. Tik op de **[!UICONTROL Advanced]** tab, selecteer het **[!UICONTROL Enable Automatic Upload]** selectievakje en tik vervolgens op **[!UICONTROL OK]**. U moet nu de DAM Asset-workflow zodanig configureren dat het uploaden naar Dynamic Media Classic wordt opgenomen.
...
1. Navigeer in de assistent naar de **[!UICONTROL Workflow]** componenten en selecteer **[!UICONTROL Dynamic Media Classic]**. Sleep **[!UICONTROL Dynamic Media Classic]** naar de workflow en tik op **[!UICONTROL Save]**. Elementen die aan AEM Assets in de doelmap worden toegevoegd, worden automatisch geüpload naar Dynamic Media Classic.
...
U kunt dit controleren door naar een Klassieke component van Dynamic Media op een pagina in AEM te navigeren en te tikken **[!UICONTROL Edit]**. De beveiligde voorvertoningsserver voor het element wordt vermeld in de URL. Na publicatie in AEM wordt het serverdomein in de bestandsverwijzing bijgewerkt van de voorbeeld-URL naar de productie-URL.
...
1. Selecteer het [!UICONTROL settings] pictogram in de werkbalk en tik op **[!UICONTROL Open Properties]**.
...
1. Tik in het hulpje op het **[!UICONTROL Page]** pictogram en tik op **[!UICONTROL Page Properties]**.
...
* Zorg ervoor dat u de wolkenconfiguratie van die pagina door hebt gevormd **[!UICONTROL Page Properties]**. Videovoorinstellingen zijn beschikbaar in de klassieke videocomponent Dynamic Media.
