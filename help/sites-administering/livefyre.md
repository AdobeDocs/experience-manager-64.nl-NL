...
seo-description: Leer hoe u Livefyre integreert en gebruikt met AEM 6.4.
...
1. Installeer het gedownloade pakket via Package Manager. Voor instructies om de Distributie van de Software en pakketten in AEM te gebruiken, zie [Werken met Pakketten](/help/sites-administering/package-manager.md).
