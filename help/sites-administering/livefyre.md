...
1. Installeer het gedownloade pakket via Package Manager. Voor instructies voor het gebruik van softwaredistributie en -pakketten in AEM raadpleegt u [Werken met pakketten](/help/sites-administering/package-manager.md).
...
1. Bewerken en opslaan */apps/social/integrations/livefyre/components/authorizablecomponent/authclientlib/auth.js* om een Livefyre Auth Delegate uit te voeren die aan uw behoeften voldoet.
   ...
   Voor meer informatie bij het aanpassen van een Afgevaardigde van de Auth, zie [Identiteitsintegratie](https://experienceleague.adobe.com/docs/livefyre/implementation/identity-integration/t-about-identity-integration.html).

   Voor meer informatie over AEM Clientlibs raadpleegt u [Client-Side bibliotheken gebruiken](/help/sites-developing/clientlibs.md).
...
Nadat Livefyre is ingeschakeld voor de pagina, moeten containers zijn geconfigureerd om Livefyre-componenten toe te staan. Zie [Componenten configureren in ontwerpmodus](/help/sites-authoring/default-components-designmode.md) voor instructies over hoe te om verschillende componenten toe te laten.
...
1. Selecteer of u een nieuwe LiveCycle-app wilt maken of een bestaande wilt insluiten.
   ...
   Zie voor meer informatie over het invoegen van componenten [Pagina-inhoud bewerken](/help/sites-authoring/editing-content.md).
