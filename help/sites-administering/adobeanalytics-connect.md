...
6. Gebruik vervolgens de **Run-modus** vervolgkeuzelijst (naast de rapportsuite-id) om de serverinstanties te selecteren die u gegevens naar de rapportsuite wilt verzenden.
