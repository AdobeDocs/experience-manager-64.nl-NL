...
2. Blader naar **Adobe Analytics** en klik op **[+]** naast **Available Configurations**.
3. Klik op de koppeling **[+]** naast uw Adobe Analytics-configuratie.

4. In het **Create Kader** dialoogvenster:
...
5. Klik in de sectie **Suites rapporteren** van de zijpod (rechterkant van het hoofddeelvenster) op **Item toevoegen**. Vervolgens gebruikt u de vervolgkeuzelijst om de rapportsuite-id te selecteren (bijvoorbeeld `geometrixxauth`) waarmee het framework zal communiceren.
...
6. Dan gebruik **de drop-down Wijze van de Looppas** (naast identiteitskaart van de Reeks van het Rapport) om de serverinstanties te selecteren die u informatie naar de Reeks van het Rapport wilt verzenden.
...
Zie [Gegevens van de Analytics van de Pagina zien](/help/sites-authoring/pa-using.md) voor verdere details.
