...
Om gegevens van de MD5 dienst van de plaats op te slaan jsontest.com, gebruik de procedure in [Creërend een Winkel ContextHub](/help/sites-administering/contexthub-config.md#creating-a-contexthub-store) gebruikend de volgende eigenschappen:
...
Gebruik de procedure in [Toevoegend een Module UI](/help/sites-administering/contexthub-config.md#adding-a-ui-module) om de module UI aan een bestaande Wijze UI, zoals de wijze toe te voegen Perona UI van de steekproef. Voor de Module UI, gebruik de volgende bezitswaarden:
