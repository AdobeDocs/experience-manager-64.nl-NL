...
Als u gegevens wilt opslaan van de MD5-service van de site jsontest.com, gebruikt u de procedure in [Een ContextHub-winkel maken](/help/sites-administering/contexthub-config.md#creating-a-contexthub-store) de volgende eigenschappen gebruiken:
...
De procedure gebruiken in [UI-modules toevoegen](/help/sites-administering/contexthub-config.md#adding-a-ui-module) om de module UI aan een bestaande Wijze UI, zoals de wijze toe te voegen Perona UI van de steekproef. Voor de Module UI, gebruik de volgende bezitswaarden:
