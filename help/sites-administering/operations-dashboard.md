...
1. De taak **Revision Clean Up **, die onder **Dagelijks Onderhoudsvenster** menu wordt gevestigd.

1. De **Lucene bindt schoonmaaktaak **taak, die onder **Dagelijks Onderhoudsvenster** menu wordt gevestigd.

1. De **Werkstroomzuivering **taak, die onder **Weekly het Venster van het Onderhoud** menu wordt gevestigd.
...
Voor meer informatie over het uitvoeren van de Opschonen van de Revisie voor AEM 6.4, [zie dit specifieke artikel](/help/sites-deploying/revision-cleanup.md).
...
>[!NOTE]
>
>Voor meer gedetailleerde informatie over het Onderhoud van het Werkschema, zie [deze pagina](workflows-administering.md#regular-purging-of-workflow-instances).
