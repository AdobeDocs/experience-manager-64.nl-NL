...
1. De taak **Revision Clean Up **, die onder **Dagelijks onderhoudvenster** -menu.

1. De **Lucene Binaries Cleanup **taak die onder **wordt gevestigd **Dagelijks onderhoudvenster** -menu.

1. De **Werkstroomzuivering **taak, die onder **Wekelijks onderhoudvenster** -menu.
...
Voor meer informatie over het uitvoeren van Revision Clean Up voor AEM 6.4, [zie dit speciale artikel](/help/sites-deploying/revision-cleanup.md).
