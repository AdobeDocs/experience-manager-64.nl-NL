...
seo-title: De invoegtoepassingen van de Rich Text Editor configureren
...
seo-description: Leer om de stop-ins van de Redacteur van de Tekst te vormen AEM Rich om individuele functionaliteit toe te laten.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Tekenreeks</td> 
   <td>String[] (multi-string; Type instellen op String en klikken op Meerdere in CRXDE Lite)</td> 
   <td>Tekenreeks</td> 
  </tr> 
  <tr> 
...
* **[!UICONTROL Plakken als tekst]**: Biedt functionaliteit voor de normale tekstmodus.
...
1. Sla de wijzigingen op.
   ...
         De *speciale karakters beschikbaar in RTE worden getoond aan auteurs in een pop-up venster*
...
1. Ga naar de pagina [http://download.services.openoffice.org/contrib/dictionaries/](http://download.services.openoffice.org/contrib/dictionaries/).
