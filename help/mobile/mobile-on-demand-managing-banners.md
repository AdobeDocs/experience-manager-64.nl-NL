...
1. Klik op de pijl-omlaag in de rechterbovenhoek van het element Banners **** beheren.
1. Werk door elke stap van de wizard om door te gaan met het maken van uw nieuwe banner.
1. Klik op **Maken** als u klaar bent.
1. De nieuwe banner wordt weergegeven in de tegel **Banners** beheren.
...
1. Kies vanuit Mobiel uw mobiele On-Demand-app in de catalogus.
1. Klik op de pijl-omlaag in de rechterbovenhoek van het element Banners **** beheren en selecteer Banners importeren.
...
1. Selecteer in het element Banners **** beheren een banner die u wilt uploaden naar Mobiel op aanvraag.
