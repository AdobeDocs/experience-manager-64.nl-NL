...
Zoals beschreven in [AEM paginasjablonen](/help/mobile/apps-architecture.md), kan elke component een JavaScript-fragment uitvoeren om de JSON-inhoud te verbruiken die door de `data` belofte wordt vrijgegeven. Volgens de Hoekconventies mag een controller alleen worden gebruikt voor het toewijzen van variabelen aan het bereik.
