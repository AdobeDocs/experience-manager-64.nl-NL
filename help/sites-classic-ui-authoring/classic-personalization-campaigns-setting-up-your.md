...
1. Voer eventueel de adresgegevens in. Klik **Opslaan** om de lead op te slaan. Als u extra leads wilt toevoegen, klikt u op** Opslaan en Nieuw**.
...
1. Selecteer **Leads importeren** in het menu **Gereedschappen**.
...
1. Selecteer **Toevoegen aan lijst in het menu** Gereedschappen **...** Het venster **Toevoegen aan lijst **wordt geopend.
