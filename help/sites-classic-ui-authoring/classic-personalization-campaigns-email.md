...
>[!NOTE]
>
>Alvorens nieuwsbrieven te verzenden, controleer de configuratie OSGi voor Dag CQ Verbinding Externalzer bij `http://localhost:4502/system/console/configMgr`.
>
