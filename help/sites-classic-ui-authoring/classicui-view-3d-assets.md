...
1. Tik **[!UICONTROL vanuit Adobe Experience Manager]** op de pagina **[!UICONTROL Navigatie]** op **[!UICONTROL Middelen]**.
...
1. Tik in de rechterbovenhoek van de pagina met elementdetails op het pictogram **[!UICONTROL Werkgebiedkiezer]** . Selecteer een werkgebiednaam met de achtergrond en de belichting die u op het 3D-element wilt toepassen.
...
1. Tik in de rechterbovenhoek van de pagina met elementdetails op het pictogram **[!UICONTROL Camera selecteren]** en selecteer een cameraweergave die u op het 3D-element wilt toepassen.
