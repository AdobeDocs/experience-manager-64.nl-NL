...
De AEM redacteur SDK van het KUUROORD werd geïntroduceerd met AEM 6.4 de dienstpak 2. Het wordt volledig gesteund door Adobe, en als nieuwe eigenschap blijft het worden verbeterd en uitgebreid. De volgende AEM eigenschappen worden nog niet behandeld door de Redacteur van het KUUROORD:
