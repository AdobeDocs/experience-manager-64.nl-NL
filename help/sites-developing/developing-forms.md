...
Al deze worden gerealiseerd met een reeks gebrek [Formuliercomponenten](/help/sites-authoring/default-components.md), beschikbaar in een standaard AEM installatie.
...
1. Een nieuwe deelmap maken ( `sling:Folder`)
...
1. Gebruik het volledige pad in het dialoogvenster **Pad items laden** veld:
...
1. Voeg desgewenst opnieuw toe aan de map:
   ...
   1. Een script voor het toevoegen van velden.
      ...
      Een addfields-script wordt direct aangeroepen nadat de HTML voor het starten van het formulier is geschreven. Hierdoor kan de actie aangepaste invoervelden of een andere HTML toevoegen in het formulier.
...
Zie voor meer informatie over de API-elementen die kunnen worden gebruikt bij het schrijven van scripts de [javadocs in verband met formulieren](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/foundation/forms/package-summary.html).
