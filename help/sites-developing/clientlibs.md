...
Standaard, `cq:ClientLibraryFolder` knooppunten kunnen overal in de `/apps`, `/libs` en `/etc` substructuren van de opslagplaats (deze standaardinstellingen en andere instellingen kunnen via de **Adobe Granite HTML Library Manager** van het [Systeemconsole](http://localhost:4502/system/console/configMgr)).
...
Voor volledige informatie, met inbegrip van attributen voor het filtreren van JS, CSS, of themabibliotheken, zie [ui:includeClientLib](/help/sites-developing/taglib.md#amp-lt-ui-includeclientlib).
...
1. CRXDE Lite openen in een webbrowser ([http://localhost:4502/crx/de](http://localhost:4502/crx/de)).
...
Voor informatie over het vormen van de dienst, zie [AEM HTML Library Manager](/help/sites-deploying/osgi-configuration-settings.md).
