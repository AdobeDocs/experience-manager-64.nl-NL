...
* [Open aem-uberjar-demo-project op GitHub](https://github.com/justinedelson/aem-uberjar-demo)
* Het project downloaden als [ZIP-bestand](https://github.com/justinedelson/aem-uberjar-demo/archive/6.2-unobfuscated.zip)

>[!NOTE]
>
>Het is ook mogelijk om deze opslagruimten te configureren in het bestand Maven *settings.xml* .

Gebruikers van andere constructiesystemen (bijvoorbeeld Apache Ant, Gradle) moeten vergelijkbare stappen volgen, aangepast aan de specifieke syntaxis van hun gekozen gereedschap.
...
### Hoe kan ik-werken met JSPs {#how-to-work-with-jsps}
...
>[!NOTE]
>
>Tenzij u de productgebiedsdelen zoals hierboven beschreven invoert, moeten zij ook aan bovenliggende POM samen met de versie worden toegevoegd die uw AEM opstelling zoals hierboven beschreven aanpast. De opmerkingen in elk van de onderstaande items tonen het pakket waarnaar u wilt zoeken in de Dependency Finder.
