...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p><code>String</code></p> <p>optioneel</p> <p>default: ""</p> </td> 
   <td>Een tekst die een beschrijving van de variatie bevat <span>(weergegeven op het tabblad <strong>Variatie</strong> van de fragmenteditor (linkerspoor)).</span></td> 
  </tr> 
 </tbody> 
</table>
