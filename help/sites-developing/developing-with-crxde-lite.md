...
1. AEM installeren.
1. Voer in uw browser https:// in`<host>`:`<port>`/crx/de. Standaard is dit `http://localhost:4502/crx/de`.
...
De hier beschreven functie is alleen beschikbaar als het knooppunttype `cq:Component` is beschikbaar in de repository.
