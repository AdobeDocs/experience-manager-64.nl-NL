...
De hier beschreven functie is alleen beschikbaar als het knooppunttype `cq:Component` beschikbaar is in de repository.
...
Met CRXDE Lite kunt u knooppunttypedefinities importeren en/of exporteren in de notatie [CND (Compacte naamruimte en Node Type Definition)](http://jackrabbit.apache.org/jcr/node-type-notation.html).
