...
>
>HTML is nu de aanbevolen scripttaal voor AEM. Zie [HTML](https://helpx.adobe.com/experience-manager/htl/user-guide.html) en het [Ontwikkelen van AEM Componenten](/help/sites-developing/developing-components.md) om methodes te vergelijken.
