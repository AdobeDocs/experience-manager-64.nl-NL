...
Hiermee worden items gevonden die lid zijn van een specifieke [slingerbronverzameling](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/org/apache/sling/resource/collection/ResourceCollection.html).
