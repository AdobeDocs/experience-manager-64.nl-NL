...
Voor informatie over het toevoegen van modules UI aan ContextHub, zie [UI-modules toevoegen](/help/sites-administering/contexthub-config.md#adding-a-ui-module). Voor informatie over het ontwikkelen van modules UI, zie [ContextHub UI-moduletypen maken](/help/sites-developing/ch-extend.md#creating-contexthub-ui-module-types).
