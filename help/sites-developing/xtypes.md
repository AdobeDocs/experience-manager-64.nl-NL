...
* box
   ...
   Basisklasse voor elke [component](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component) waarvan de grootte als vak moet worden aangepast, met breedte en hoogte.
...
* browsedialoogvenster
   ...
   Met het dialoogvenster BrowseDialog kan de gebruiker door de opslagplaats bladeren om een pad te selecteren. Het wordt typisch gebruikt door een [BrowseField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.BrowseField).
...
* browsefield
   ...
   **Vervangen: Gebruik in[plaats hiervan CQ.form.PathField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.PathField).**
...
* checkbox-groep
   ...
   Een groeperingscontainer voor besturingselementen van [CQ.Ext.form.Checkbox](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Checkbox) .
...
* kleurveld
   ...
   Met het ColorField kan de gebruiker een hexadecimale kleurwaarde rechtstreeks invoeren of een [CQ.Ext.ColorMenu](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorMenu)gebruiken.
...
* colormenu
   ...
   Een menu met een [component CQ.Ext.ColorPalette](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorPalette) .
...
* contentfinder
   ...
   De ContentFinder is een gespecialiseerde [Viewport](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Viewport) met twee kolommen, die de daadwerkelijke Inhoudszoeker links en het Inhoudskader rechts bevat.
...
* datefield
   ...
   Verstrekt een gebied van de datuminput van [CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) dropdown en automatische datumbevestiging.
...
* datemenu
   ...
   Een menu met een [component CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) .
...
* datepicker
   ...
   Een kiezer voor de pop-updatum. Deze klasse wordt door de [klasse DateField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.DateField) gebruikt om bladeren en selectie van geldige datums toe te staan.
...
* listview
   ...
   CQ.Ext.list.ListView is een snelle en lichtgewichtimplementatie van een [Net](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel) als mening.
...
* lvcolumn
   ...
   Deze klasse kapselt de gegevens van de kolomconfiguratie in die in de initialisering van een [ListView](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.ListView)moeten worden gebruikt.
...
* mediabrowsedialoog
   ...
   **Vervangen: Gebruik in plaats hiervan de[Content Finder](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder)om te bladeren in media.**
...
* password
   ...
   Het wachtwoord is vergelijkbaar met een [CQ.Ext.form.TextField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TextField) , maar behoudt de waarde ervan als privé, zodat gebruikers gevoelige gegevens kunnen invoeren.
...
* rolloutplan
   ...
   Het rolloutPlan verstrekt een dialoog om de vooruitgang van de paginaloprijving te bekijken. RolloutPlan is begonnen door een [CQ.wcm.msm.RolloutWizard](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutWizard).
...
* tableedit
   ...
   **Vervangen: Gebruik in[plaats hiervan CQ.form.TableEdit2](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.TableEdit2).**
