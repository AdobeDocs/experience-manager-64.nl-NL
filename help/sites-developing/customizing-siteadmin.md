...
1. Kopieer het knooppunt `/apps/wcm/core/content/siteadmin/grid/assets` naar de eigenschappen `/apps/wcm/core/content/siteadmin/grid/geometrixx` en wijzig deze:
   ...
   * PadRegex **** instellen op `/content/geometrixx(/.*)?`
