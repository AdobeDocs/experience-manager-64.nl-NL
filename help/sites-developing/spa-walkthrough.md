...
1. Selecteer een koptekstcomponent. Een werkbalk ziet er net zo uit als een andere component. Selecteer **[!UICONTROL Edit]**.
...
1. Laad de toepassing Wij.Retail Journal op de publicatieserver of met de optie **[!UICONTROL View as Published]** in het menu **Pagina-informatie** in de paginaeditor.
...
1. Als niet reeds geladen, laad de toepassing van het Dagboek Wij.Retail of op de publicatieserver of gebruikend de optie **[!UICONTROL View as Published]** van het menu van de Informatie **van de** Pagina in de paginaredacteur.
...
1. Laad de aanwijzer `react.model.json` in een nieuw tabblad.
   ...
   De AEM redacteur van het KUUROORD hefboomwerkingen [AEM de Diensten](/help/assets/content-fragments.md) van de Inhoud om de volledige inhoud van de pagina als model te leveren JSON.
