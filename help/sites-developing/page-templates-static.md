...
1. In de **Query** invoerveld, voer de volgende tekenreeks in:

   //element(&amp;ast;, cq:Sjabloon)
...
Als u een bestaande sjabloon wilt inschakelen voor uw website, moet deze worden weergegeven in het dialoogvenster **Pagina maken** een pagina maken onder **Websites** van de **Websites** console, plaats het allowedPaths bezit van de malplaatjeknoop aan: **/content(/.&amp;last;)?**
