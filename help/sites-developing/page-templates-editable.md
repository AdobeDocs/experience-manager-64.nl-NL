...
1. **Sjabloon inschakelen**
   ...
   * [Het toelaten van het malplaatje](/help/sites-authoring/templates.md#enabling-and-allowing-a-template-template-author) van de console van **Malplaatjes** .
...
* Configuratie - `/conf/<my-folder>/settings/wcm/templates/<my-template>`
   ...
   De paginasonfiguratie wordt gedefinieerd door de [sjabloon en het bijbehorende inhoudsbeleid](#template-definitions) .
