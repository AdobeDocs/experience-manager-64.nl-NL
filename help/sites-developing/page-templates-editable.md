...
1. Vorm de structuur, inhoudsbeleid, aanvankelijke inhoud, en lay-out van het nieuwe malplaatje.
   ...
   * Deze zijn van toepassing op de sjabloon (en op pagina&#39;s die met de sjabloon zijn gemaakt).
   ...
   Voor technische details van het beleid, zie [Inhoudsbeleid](/help/sites-developing/page-templates-editable.md#content-policies) in dit document.
...
1. **Sjabloon inschakelen**
   ...
   * [De sjabloon inschakelen](/help/sites-authoring/templates.md#enabling-and-allowing-a-template-template-author) van de **Sjablonen** console.
...
* Model - OSGi-bundels
   ...
   De [OSGI-pakketten](/help/sites-deploying/osgi-configuration-settings.md) de functionaliteit implementeren.
