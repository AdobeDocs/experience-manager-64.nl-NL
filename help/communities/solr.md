...
1. Voor MSRP, looppas [MSRP Reindex Tool](msrp.md#msrp-reindex-tool), tenzij dit een nieuwe installatie is
...
1. Kopieer de gedownloade **schema.xml** en **solrconfig.xml** naar dezelfde map
...
1. Een nieuwe configuratie voorbereiden:
   ...
   1. Voor Solr5: Kopieer *solr_install_dir*/server/solr/configsets/sample_techproducts_configs/conf/lang/&amp;ast;.txt&quot; naar *new-config-dir*/lang/
   1. Kopieer de uitgepakte **stopwords/** map naar *new-config-dir* resulterend in *new-config-dir*/stopwords/&amp;ast;.txt
