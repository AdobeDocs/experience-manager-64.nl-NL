...
* [Door de ](moderation.md) gebruiker gegenereerde inhoud (UGC) moderniseren
* [Enablement resource](resources.md) contactpersonen zijn
* [geprivilegieerd](#privileged-members-group) zijn om berichten te maken voor blogs, kalenders, QnA en forums

Gebruikers die zijn geregistreerd in de publicatieomgeving worden doorgaans *communityleden (leden)* genoemd om ze te onderscheiden van *users *in de auteursomgeving.
...
Afhankelijk van de [instellingen](sites-console.md#user-management) van de communitysite kan een sitebezoeker in de publicatieomgeving lid worden van de community
...
2. `community-enablementmanagers` zoeken en naar het tabblad **[!UICONTROL Groups]** van de nieuwe gebruiker in het rechterdeelvenster slepen
