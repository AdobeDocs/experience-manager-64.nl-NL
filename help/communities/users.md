...
* [Gemiddeld](moderation.md) door gebruiker gegenereerde inhoud (UGC)
* zijn [enablement resource](resources.md) contactpersonen
* zijn [bevoorrecht](#privileged-members-group) om items te maken voor blogs, kalenders, QnA en forums

In de publicatieomgeving geregistreerde gebruikers worden doorgaans *leden van de gemeenschap ( leden )* om hen van *users *in het auteursmilieu te onderscheiden.
...
* [Blogfunctie](functions.md#blog-function) - het aanmaken van nieuwe artikelen te beperken
* [Kalenderfunctie](functions.md#calendar-function) - de oprichting van nieuwe evenementen te beperken
* [Forum, functie](functions.md#forum-function) - het creëren van nieuwe onderwerpen te beperken
* [QnA-functie](functions.md#qna-function) - het creëren van nieuwe vragen te beperken
...
2. Zoeken en slepen `community-enablementmanagers` aan de **[!UICONTROL Groups]** tabblad van de nieuwe gebruiker die in het rechterdeelvenster wordt weergegeven
