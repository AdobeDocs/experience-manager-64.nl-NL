...
* **[!UICONTROL Maximale bestandsgrootte]** is alleen relevant als **[!UICONTROL Uploaden]** van bestand toestaan is ingeschakeld. Dit veld beperkt de grootte (in bytes) van een geüpload bestand. De standaardwaarde is 10 MB.
