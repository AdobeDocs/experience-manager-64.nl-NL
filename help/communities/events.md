...
Voor een aangepaste component moet de abstracte klasse [](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/adobe/cq/social/scf/core/SocialEvent.html) SocialEvent worden uitgebreid om de gebeurtenissen van de component op te nemen zoals `actions`die voor een `topic`.
