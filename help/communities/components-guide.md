...
>[!NOTE]
>
>Houd er rekening mee dat als de standaard SRP op [JSRP](jsrp.md) is ingesteld, UGC die op de publicatieinstantie is ingevoerd, alleen zichtbaar is bij publicatie en *not *niet zichtbaar is vanaf de [moderation](moderate-ugc.md)-console op de auteurinstantie.
