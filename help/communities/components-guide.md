...
>[!NOTE]
>
>Houd rekening met het volgende als de SRP in gebreke blijft [JSRP](jsrp.md), is UGC die u hebt ingevoerd in de publicatie-instantie alleen zichtbaar bij publicatie en *niet *in het dialoogvenster [matiging](moderate-ugc.md) console op de auteurinstantie.
