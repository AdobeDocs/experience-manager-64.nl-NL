...
* Installeer in alle AEM het officiële [JDBC-stuurprogramma voor MySQL](deploy-communities.md#jdbc-driver-for-mysql)
* MySQL- [werkbank installeren](https://dev.mysql.com/downloads/tools/workbench/)
* Installeer het [SCORM-pakket bij alle AEM](enablement.md#scorm)
